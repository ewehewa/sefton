...
} elseif ($_instance->childHasBeenRendered('G1L2FWR')) {
    $componentId = $_instance->getRenderedChildComponentId('G1L2FWR');
    $componentTag = $_instance->getRenderedChildComponentTagName('G1L2FWR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('G1L2FWR');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('G1L2FWR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hebkghti/public_html/ciitesonline.com/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>