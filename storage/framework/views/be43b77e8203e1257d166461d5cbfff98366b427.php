<div>
    ...
    <div class="alert alert-group alert-warning alert-icon alert-dismissible fade show" role="alert">
        <div class="alert-content">
           Our automatic USDT payment is powered by Binance, in order for you to receive your funds, please make sure you have a binance account registered with the same email address on our platform. If you do not have a binance account please <a href="https://www.binance.com/en" target="_blank" class="btn-link">create an account.</a> <strong>NOTE: do not proceed with this request if you do not have a binance account or you have an account with a different email address so you don't lose your funds.</strong>
        </div>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    ...
    <form action="" method="post" wire:submit.prevent='withdraw'>
        <div class="form-group">
            ...
            <input class="form-control " placeholder="Enter Amount" type="number" wire:model='amount' name="amount" required>
        </div>
        ...
        <?php endif; ?>
        <div class="form-group">
            <button class="btn btn-primary" wire:loading.attr='disabled' wire:target='withdraw' type='submit'>Complete Request</button>
        </div>
    </form>
</div>
<?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/livewire/user/crypto-withdaw.blade.php ENDPATH**/ ?>