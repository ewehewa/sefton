...
} elseif ($_instance->childHasBeenRendered('3kWLRYB')) {
    $componentId = $_instance->getRenderedChildComponentId('3kWLRYB');
    $componentTag = $_instance->getRenderedChildComponentTagName('3kWLRYB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3kWLRYB');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('3kWLRYB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('LDqhj6C')) {
    $componentId = $_instance->getRenderedChildComponentId('LDqhj6C');
    $componentTag = $_instance->getRenderedChildComponentTagName('LDqhj6C');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LDqhj6C');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('LDqhj6C', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acinvest/app/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>