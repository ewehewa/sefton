...
<div class="lg:hidden" x-data="{ showMobileNotifications: false }">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center space-x-2">
            <?php if($showBackButton): ?>
                <!-- Back Button -->
                <a href="<?php echo e($backUrl); ?>" class="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center backdrop-blur-sm transition-all duration-200 hover:bg-gray-200 dark:hover:bg-gray-700 mr-2">
                    <i class="fa-solid fa-arrow-left text-gray-700 dark:text-gray-300 text-base"></i>
                </a>
            <?php else: ?>
                <!-- Profile Avatar -->
                <img src="<?php echo e($financeUser->avatarUrl); ?>" alt="Profile" class="w-10 h-10 rounded-full border-2 border-gray-200 dark:border-gray-700">
            <?php endif; ?>
            
            <div>
                <?php if($title): ?>
                    <!-- Custom Title -->
                    <p class="text-gray-900 dark:text-white font-semibold text-base"><?php echo e($title); ?></p>
                <?php else: ?>
                    <!-- Default Greeting -->
                    <p class="text-gray-600 dark:text-gray-400 text-xs" x-text="greeting + ' 👋'"></p>
                    <p class="text-gray-900 dark:text-white font-semibold text-base"><?php echo e(explode(' ', $financeUser->name)[0]); ?> <?php echo e(Auth::user()->lastname); ?></p>
                <?php endif; ?>
            </div>
        </div>
            ...
            <?php if($showNotifications): ?>
                ...
                <div class="relative">
                    ...
                    <?php if($mobileUnreadCount > 0): ?>
                        <span class="absolute -top-1 -right-1 w-5 h-5 bg-red-500 dark:bg-red-600 rounded-full flex items-center justify-center text-xs font-bold text-white animate-pulse"><?php echo e($mobileUnreadCount > 9 ? '9+' : $mobileUnreadCount); ?></span>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
    ...
    <?php endif; ?>
</div> <?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/partials/_mobile_header.blade.php ENDPATH**/ ?>