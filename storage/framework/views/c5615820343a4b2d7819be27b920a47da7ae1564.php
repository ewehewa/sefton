...
} elseif ($_instance->childHasBeenRendered('SpFF9Ij')) {
    $componentId = $_instance->getRenderedChildComponentId('SpFF9Ij');
    $componentTag = $_instance->getRenderedChildComponentTagName('SpFF9Ij');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SpFF9Ij');
} else {
    $response = \Livewire\Livewire::mount('admin.manage-users', []);
    $html = $response->html();
    $_instance->logRenderedChild('SpFF9Ij', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
