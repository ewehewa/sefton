...
<?php endif; ?>
        ...
        <div class="hidden lg:flex items-center justify-between mb-4">
            <div class="flex items-center space-x-2">
                <a href="<?php echo e(route('account.verify')); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-600 transition-colors">
        ...
        <div class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 dark:border-gray-700/50 overflow-hidden mb-4">
            ...
            <div class="p-4 lg:p-5">
                <form action="<?php echo e(route('kycsubmit')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-lg shadow-sm">
                                        ...
                                        <input type="text" name="name" id="name" value='<?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?>' class="pl-10 block w-full py-2 pr-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 relative z-0" required>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-lg shadow-sm">
                                        ...
                                        <input type="email" name="email" id="email" value='<?php echo e(Auth::user()->email); ?>' class="pl-10 block w-full py-2 pr-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 relative z-0" required>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-lg shadow-sm">
                                        ...
                                        <input type="text" name="phone" id="phone" value='<?php echo e(Auth::user()->phone); ?>' class="pl-10 block w-full py-2 pr-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 relative z-0" required>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-lg shadow-sm">
                                        ...
                                        <input type="text" name="country" id="country" value='<?php echo e(Auth::user()->country); ?>' class="pl-10 block w-full py-2 pr-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 relative z-0" required>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/verification.blade.php ENDPATH**/ ?>