...
} elseif ($_instance->childHasBeenRendered('7q8Sc8A')) {
    $componentId = $_instance->getRenderedChildComponentId('7q8Sc8A');
    $componentTag = $_instance->getRenderedChildComponentTagName('7q8Sc8A');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7q8Sc8A');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('7q8Sc8A', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('9dfdxfN')) {
    $componentId = $_instance->getRenderedChildComponentId('9dfdxfN');
    $componentTag = $_instance->getRenderedChildComponentTagName('9dfdxfN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9dfdxfN');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('9dfdxfN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
