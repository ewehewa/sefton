...
<?php endif; ?>
    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-white/20 dark:border-gray-700/50 overflow-hidden">
        ...
        <!-- Form Content -->
        <div class="p-4">
            <form action="<?php echo e(route('updateuserpass')); ?>" method="post" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/editpass.blade.php ENDPATH**/ ?>