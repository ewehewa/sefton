                    ...
                    <div class="card  shadow-lg p-2 p-md-4">
                        <div class="card-body">
                            <?php if($title !="Complete Payment"): ?>
                                ...
                                ?>
                                <div>
                                    <h4 class="">You are to make payment of <strong><?php echo e($settings->currency); ?><?php echo e(number_format($amount)); ?></strong> using your selected payment method. Screenshot and upload the proof of payment</h4>
                                    <h4>
                                        <?php if((!empty($payment_mode->barcode) or $payment_mode->barcode != NULL) and $payment_mode->methodtype != 'currency'): ?>
                                            <div class="text-center">
                                                <img src="<?php echo e(asset('storage/app/public/photos/'.$payment_mode->barcode)); ?>" alt="" class="w-50">
                                            </div>
                                            <?php endif; ?>
                                        <strong class=""><?php echo e($payment_mode->name); ?></strong>
                                    </h4>
                                </div>
                                    ...
                                    <?php if($payment_mode->methodtype != 'currency'): ?>
                                        ...
                                        <div class="form-group">
                                            <div class="fv-row mb-6">
                                                ...
                                                <input class="form-control form-control-lg form-control-solid " readonly   type="text" id="myInput" value="<?php echo e($payment_mode->wallet_address); ?>" multiple />
                                                ...
                                                <small class=""><strong>Network Type:</strong> <?php echo e($payment_mode->network); ?></small>
                                        </div>
                                        ...
                                        <h3 class="">
                                            ...
                                            <?php if($payment_mode->defaultpay == 'yes'): ?>
                                                ...
                                                <div class="mb-3 input-group">
                                                    <input type="text" class="form-control myInput readonly  " value="<?php echo e($payment_mode->bankname); ?>" readonly>
                                                ...
                                                <div class="mb-3 input-group">
                                                    <input type="text" class="form-control myInput readonly  " value="<?php echo e($payment_mode->account_name); ?>" readonly>
                                                    <div class="input-group-append">
                                                        <button class="btn btn-outline-secondary" onclick="myFunction()" type="button" id="button-addon2" disabled><i class="fas fa-copy"></i></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 input-group">
                                                    <input type="text" class="form-control myInput readonly  " value="<?php echo e($payment_mode->account_number); ?>" readonly>
                                                    <div class="input-group-append">
                                                        <button class="btn btn-outline-secondary" onclick="myFunction()" type="button" id="button-addon2" disabled><i class="fas fa-copy"></i></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 input-group">
                                                    <input type="text" class="form-control myInput readonly  " value="<?php echo e($payment_mode->swift_code); ?>" readonly>
                                                    <div class="input-group-append">
                                                        <button class="btn btn-outline-secondary" onclick="myFunction()" type="button" id="button-addon2" disabled><i class="fas fa-copy"></i></button>
                                                    </div>
                                                </div>
                            ...
                            <?php if($title=="Complete Payment"): ?>
                                <div class="p-2 text-center p-md-5">
                                    <h4 class="">Send <?php echo e($amount); ?> to the below address or scan the <?php echo e($coin); ?> QR code to complete payment.</h4>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/user/payment.blade.php ENDPATH**/ ?>