    ...
    <div class="col-12">
        <form method="post" action="<?php echo e(route('updatewebinfo')); ?>" id="appinfoform" enctype="multipart/form-data">
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="sms" value="1" class="selectgroup-input"
                                <?php echo e($settings->sms == '1' ? 'checked' : ''); ?>>
                            <span class="selectgroup-button">On</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="sms"
                                <?php echo e($settings->sms != '1' ? 'checked' : ''); ?> value="0"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <h5 class="text-<?php echo e($text); ?>">Favicon (Recommended type: png, size: max width, 32px and max
                        height 32px.)</h5>
...
<?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/admin/Settings/AppSettings/webinfo.blade.php ENDPATH**/ ?>