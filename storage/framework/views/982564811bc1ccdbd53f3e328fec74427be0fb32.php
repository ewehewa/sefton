            ...
            <div class="modal-body text-left">
                <form action="<?php echo e(route('updatestrategy')); ?>" method="post">
                    ...
                    <div class="form-group" id="optionSelected">
                        ...
                        <input type="text" name="" value="<?php echo e($item['stra_com']); ?>" class="form-control"
                            id="optionInput">
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="account_id" value="<?php echo e($item['id']); ?>">
...
<?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/admin/subscription/master/renew-master.blade.php ENDPATH**/ ?>