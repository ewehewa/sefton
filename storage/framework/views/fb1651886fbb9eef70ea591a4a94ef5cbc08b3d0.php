                    ...
                    <div class="space-y-5 mb-6">
                        <div>
                            ...
                            <div class="mt-1 relative rounded-lg shadow-sm">
                                ...
                                <input type="number" name="requested_amount" id="requested_amount" min="1" value="<?php echo e(old('requested_amount', $application ? $application->requested_amount : 5000)); ?>" class="shadow-sm focus:ring-primary-500 focus:border-primary-500 px-2 py-2.5 pl-12 border block w-full text-sm border-gray-300 dark:border-gray-600 rounded-lg bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 relative z-0" required>
                            </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/grant/individual.blade.php ENDPATH**/ ?>