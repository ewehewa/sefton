            ...
            ID: <?php echo e(Auth::user()->usernumber); ?>
                ...
                <nav class="flex-1 px-4 space-y-1">
                   ...
                   <a href="<?php echo e(route('localtransfer')); ?>" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('localtransfer') ? 'bg-primary-50 text-black border-l-4 border-primary-500 pl-2' : 'text-gray-700 hover:bg-gray-50'); ?>">
                    ...
                    <a href="<?php echo e(route('grant.index')); ?>" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('grant*') ? 'bg-primary-50 text-black border-l-4 border-primary-500 pl-2' : 'text-gray-700 hover:bg-gray-50'); ?>">
                        <i data-lucide="hand-coins" class="mr-3 h-5 w-5 <?php echo e(request()->routeIs('grant*') ? 'text-black' : 'text-gray-500'); ?>"></i>
                        Grant Applications
                    </a>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:flex items-center px-3 py-1.5 bg-primary-50 rounded-full">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format(Auth::user()->account_bal,0, '.', ',')); ?>
...
>
    ...
    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <a href="https://nexatrustcapital.com/dashboard/internationaltransfer" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-secondary-50 to-secondary-100 hover:from-secondary-100 hover:to-secondary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <a href="<?php echo e(route('grant.index')); ?>" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-secondary-50 to-secondary-100 hover:from-secondary-100 hover:to-secondary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                                    <i data-lucide="file-text" class="h-5 w-5 text-secondary-600"></i>
                                </div>
                                <span class="text-xs font-medium text-gray-700">Grants</span>
                            </div>
                        </a>
...
_smartsupp.key = 'cb79dbc1ccace71e05f1db473582a37f9edd615c';
...
</html><?php /**PATH /home/nexatrus/public_html/resources/views/layouts/dash2.blade.php ENDPATH**/ ?>