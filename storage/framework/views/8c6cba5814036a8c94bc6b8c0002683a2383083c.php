...
<?php endif; ?>
                <div class="mb-5 row">
                    <div class="col-lg-12 card p-4 shadow">
                        <form method="POST" action="<?php echo e(route('transaction.generate')); ?>" id="transaction-form">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="min_amount">Minimum Amount (<?php echo e($settings->currency); ?>)</label>
                                        <input type="number" class="form-control" name="min_amount" id="min_amount" step="0.01" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="max_amount">Maximum Amount (<?php echo e($settings->currency); ?>)</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/admin/transaction-history/generate.blade.php ENDPATH**/ ?>