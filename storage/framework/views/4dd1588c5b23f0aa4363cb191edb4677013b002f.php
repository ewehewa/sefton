                    ...
                    <div class="mb-8 bg-gradient-to-br from-gray-50 to-white p-5 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <span class="text-gray-500 text-lg font-bold"><?php echo e(Auth::user()->s_curr); ?></span>
                            </div>
                            <input 
                                type="number" 
                                name="amount" 
                                ...
                                min="1" 
                                max="<?php echo e(Auth::user()->account_bal); ?>"
                                step="any"
                        ...
                        <div class="mt-3 flex items-center justify-between">
                            <p class="text-sm text-gray-500">Available balance: <span class="font-medium"><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format(Auth::user()->account_bal, 2, '.', ',')); ?></span></p>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wspbglobal/public_html/resources/views/user/international.blade.php ENDPATH**/ ?>