...
} elseif ($_instance->childHasBeenRendered('tzErqdp')) {
    $componentId = $_instance->getRenderedChildComponentId('tzErqdp');
    $componentTag = $_instance->getRenderedChildComponentTagName('tzErqdp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tzErqdp');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('tzErqdp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH /home/remedyfinance/public_html/resources/views/admin/subscription/master/statistics.blade.php ENDPATH**/ ?>