...
<article class="main-layout__content">
   ...
   text-align: center;
               ...
               <h1 class="page-intro__title" id="class"style="color: #fff;"><?php echo e($settings->site_name); ?>- PROFESSIONAL TEAM<br>CRYPTO INDUSTRY DEVELOPERS</h1>
                 <div class="typography"> 
                 <p> Our company has been developing stable cryptocurrency income for 6 years. Today <?php echo e($settings->site_name); ?> employees are leaders in the field of IT technologies. They have created a unique robot that generates daily profit and guesses the steps of the Bitcoin value. That is why the <?php echo e($settings->site_name); ?>robot is able to benefit at any stage of the market: both growth and decline. This development is unique in that it is the first in the world. Today, not many people know about this. That is why they are given the chance to receive a stable income for the rest of their lives. Many people will try to fake it in fraudulent ways after the platform is known around the world. But we assure that only our company <?php echo e($settings->site_name); ?>is unique. </p>
                 
                 <p><p>  <?php echo e($content->getContent('rCTDQh','description')); ?></p></p>
                 </div>
               </div>
             </div>
           </section>
               ...
               <div class="company__block"> 
                 <div class="company__row"> 
                       ...
                       <table> 
                         <tbody> 
                           <tr> 
                             ...
                             <td><?php echo e($settings->site_name); ?>LTD</td>
                           </tr>
                           <tr> 
                             <td> 
                           ...
                           <tr> 
                             ...
                             <td> <?php echo e($settings->address_o); ?></td>
                           </tr>
                         </tbody>
                       </table>
                     </div>
                   ...
                   <div class="company__col"> 
                     ...
                     <div class="typography"> 
                       <blockquote><?php echo e($settings->site_name); ?>- UK LEGAL REGISTRATION <a href="">№13699699</a></blockquote>
           ...
           <section class="text-columns">
             <div class="container">
               <h1 class="page-intro__title" id="classs"style="color: #69e2b0;"><?php echo e($settings->site_name); ?> STATS</h1>
               <div class="typography"> 
                 <p> Here are online statistics of our company. Competent distribution of investments in the <?php echo e($settings->site_name); ?>robot allows you to maximize profits at all stages of the market. Gradual development is a guarantee of world recognition in the market. It is important for us to ensure the protection of our investors, as well as the stability and uninterrupted operation of the platform. The <?php echo e($settings->site_name); ?> robot is fully automated to operate without user intervention.</p>
               </div>
             </div>
           </section>
                 ...
                 <div class="swiper-wrapper">
                   ...
                   <div class="swiper-slide">
                     <div class="count-item"> 
                       ...
                       <p class="count-item__value"style="width: 100%;text-align: center;"><?php echo e($total_users+89650); ?>                       </p>
                       <div class="count-item__description"style="max-width: 100%;text-align: center;">
                         <p>Total Members</p>
                       </div>
                     </div>
                   ...
                   <div class="swiper-slide">
                     <div class="count-item"> 
                       ...
                       <p class="count-item__value"style="width: 100%;text-align: center;"><?php echo e($total_deposits+338400989); ?> <sub>USD</sub>
                       </p>
                       <div class="count-item__description"style="max-width: 100%;text-align: center;">
                         <p>Total Invested</p>
                       </div>
                   ...
                   <div class="swiper-slide">
                     <div class="count-item"> 
                       ...
                       <p class="count-item__value"style="width: 100%;text-align: center;"><?php echo e($total_withdrawals+101689885); ?><sub>USD</sub>
                       </p>
                       <div class="count-item__description"style="max-width: 100%;text-align: center;">
                         <p>Total Paid</p>
                       </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/demo.remedyfinance.online/resources/views/home/about.blade.php ENDPATH**/ ?>