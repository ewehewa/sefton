...
} elseif ($_instance->childHasBeenRendered('hO0IE9W')) {
    $componentId = $_instance->getRenderedChildComponentId('hO0IE9W');
    $componentTag = $_instance->getRenderedChildComponentTagName('hO0IE9W');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hO0IE9W');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('hO0IE9W', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acinvest/app/resources/views/user/withdraw.blade.php ENDPATH**/ ?>