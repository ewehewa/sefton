...
} elseif ($_instance->childHasBeenRendered('7tp6SUs')) {
    $componentId = $_instance->getRenderedChildComponentId('7tp6SUs');
    $componentTag = $_instance->getRenderedChildComponentTagName('7tp6SUs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7tp6SUs');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('7tp6SUs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/user/withdraw.blade.php ENDPATH**/ ?>