...
} elseif ($_instance->childHasBeenRendered('GwJhKtX')) {
    $componentId = $_instance->getRenderedChildComponentId('GwJhKtX');
    $componentTag = $_instance->getRenderedChildComponentTagName('GwJhKtX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GwJhKtX');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('GwJhKtX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>