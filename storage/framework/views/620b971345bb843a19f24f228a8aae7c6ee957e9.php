                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo e(route('sendpasswordrequest')); ?>"  class="mt-4 login-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-4 mb-0"><small class="mr-2 text-white">&copy; Copyright  <?php echo e(date('Y')); ?> &nbsp; <?php echo e($settings->site_name); ?> &nbsp; All Rights Reserved.</small>
                                        </p>
                                    </div>
                                </div>
                                <!--end row-->
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/auth/admin-forgot-password.blade.php ENDPATH**/ ?>