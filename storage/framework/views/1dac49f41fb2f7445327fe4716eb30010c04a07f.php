                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <input type="text" class=" form-control text-center text-white btn-primary" name ="email" value="<?php echo e($captcha); ?>"  readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end col-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/public_html/demo3.remedyfinance.online/resources/views/home/verify.blade.php ENDPATH**/ ?>