...
} elseif ($_instance->childHasBeenRendered('caJmJhh')) {
    $componentId = $_instance->getRenderedChildComponentId('caJmJhh');
    $componentTag = $_instance->getRenderedChildComponentTagName('caJmJhh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('caJmJhh');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('caJmJhh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH /home/remedyfinance/public_html/account/resources/views/admin/subscription/master/statistics.blade.php ENDPATH**/ ?>