                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <?php endif; ?>
                                          ...
                                          <h1 class=" pl-2 d-inline text-primary"><?php echo e($user->name); ?> <?php echo e($user->middlename); ?> <?php echo e($user->lastname); ?></h1><span></span>
                                        <div class="d-inline">
                                            <div class="float-right btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-lg-right">
                                                    ...
                                                    <a href="#" data-toggle="modal" data-target="#banUserModal"
                                                        class="dropdown-item <?php echo e($user->isBanned() ? 'text-warning' : 'text-danger'); ?>">
                                ...
                                <div class="p-3 mt-4 border rounded row ">
                                    ...
                                    <div class="col-md-3">
                                        <h5>Grant Limit</h5>
                                        <p><?php echo e($user->s_curr); ?><?php echo e(number_format($user->grant_limit)); ?> </p>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/admin/Users/userdetails.blade.php ENDPATH**/ ?>