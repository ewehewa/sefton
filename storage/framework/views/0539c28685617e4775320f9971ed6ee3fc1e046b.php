...
<head>
    ...
    <meta content="Advanced Asset Management. Get 3%-5% Daily Profit Guaranteed" name="description">
    <meta content="nxa" name="author">
    <meta name="keywords" content="investment, investments, online earning, <?php echo e($settings->site_name); ?>, <?php echo e($settings->site_name); ?>, crypto investments, roi, passive income, asset management, stable profit, daily profit, bitcoin, trading, Return on investment, ethereum, litecoin, dogecoin, forex, etfs, indicies, stock exchange, commodities, cryptocurrency, shares, options, bonds, gold, silver, platinum, hyip, high yeld investment program,investors protect, investors-protect, hyip zanoza, hyip logs, hyip monitor">
    <!-- ================== BEGIN BASE CSS STYLE ================== -->
    <link href="temp/custom/cssff98.html?family=Open+Sans:300,400,600,700" rel="stylesheet">
    <link href="temp/custom/assets/css/one-page-parallax/app.min.css" rel="stylesheet">
    <!-- ================== END BASE CSS STYLE ================== -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('storage/app/public/'.$settings->favicon)); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('storage/app/public/'.$settings->favicon)); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('storage/app/public/'.$settings->favicon)); ?>">
    <link rel="manifest" href="/">
    <link rel="mask-icon" href="safari-pinned-tab.html" color="#343536">
    <meta name="msapplication-TileColor" content="#343536">
    <meta name="theme-color" content="#343536">
    <meta property="og:title" content="<?php echo e($settings->site_name); ?> LTD.">
    <meta property="og:description" content="Advanced Asset Management">
    <meta property="og:image" content="<?php echo e(asset('storage/app/public/'.$settings->favicon)); ?>">
...
<body data-spy="scroll" data-target="#header" data-offset="51">
    ...
    <div id="page-container" class="fade">
        ...
        <div id="header" class="header navbar navbar-inverse navbar-fixed-top navbar-expand-lg">
            ...
            <div class="container">
                <!-- begin navbar-brand -->
                <a href="/" class="navbar-brand"><img src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>" alt=""width="120" height="100"> </a>
                <!-- end navbar-brand -->
                <!-- begin navbar-toggle -->
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="d-none d-md-inline-block nav-item mt-auto mb-auto">
                            <a href="register" class="btn btn-primary">Register an Account</a>
                        </li>
                        ...
                        <li class="d-md-none nav-item mt-auto mb-auto">
                            <a href="register" style="margin-left: 12px" class="mt-2 mb-3 btn btn-primary">Register an Account</a>
                            <a href="login" class="ml-3 mt-2 mb-3 btn btn-outline-white">Sign In</a>
        ...
        <div id="home" class="content has-bg home">
            <!-- begin content-bg -->
            <div class="content-bg" style="background-image: url(assets/img/bg/bg-home5.jpg);" data-paroller="true" data-paroller-factor="0.5" data-paroller-factor-xs="0.25">
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
            <script>
            ...
            <div class="container home-content">
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <h1><span class="text-primary"><img src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>"alt=""width="250" height="100" ></h1>
                        <h3>Advanced Asset Management</h3>
                        <h5 class="d-none d-md-inline-block">Use our Investment plan and get up to 350% Return</h5>
                        <h6 class="d-md-none">Use our Investment plan and get up to 250% Return</h6>
                        <!--<h5 class="text-primary">Cancel Your Deposit at any time</h5>-->
                        <br>
                        <a href="register" class="btn btn-theme btn-primary">Register an Account</a>
                        <a href="login" class="btn btn-theme btn-outline-white">Sign In</a>
                        <br>
                    </div>
                </div>
                <!-- iris eye -->
                ...
                <p class="content-desc">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <!-- begin about -->
                            <div class="about">
                                <h3 class="mb-3">What is <?php echo e($settings->site_name); ?>?</h3>
                                <p class="desc text-justify" style="line-height: 1.6rem">
                                    With the help of <?php echo e($settings->site_name); ?>, you are able to earn money without leaving your home, and what's more, without making any risky decisions. We have developed a system that guarantees constant passive income in 3 investment plans. Our company is
                                    located in London, we gather people with great experience and trading skills in all international markets. We use professional, advanced tools that are not available to average users. Our analyzes diversify any risk
                                    of loss. The capital owned by our company guarantees the actions of our employees, because the profit is guaranteed for investors. How much can you earn by investing with us? 3% to 5% of total passive income per day.
                                    The return of the invested deposit is usually returned after 30, 40 or 50 days. Due to our complete transparency to investors, we offer the possibility to cancel your deposit and withdraw it at any time. We offer an
                                    easy-to-use interface, thanks to which you can start your adventure with investing in a few minutes </p>
                            </div>
                            <!-- end about -->
                        </div>
                        <!-- begin col-4 -->
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="about-author">
                                ...
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/njif_-qTN0o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                                </div>
                            </div>
                            <!-- end about-author -->
                        </div>
        ...
        <div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg" style="background-image: url(assets/img/bg/bg-home3.jpg);" data-paroller="true" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01"></div>
            <!-- end content-bg -->
            <!-- begin container -->
            <div class="container">
                <!-- begin row -->
                <div class="row">
                    ...
                    <div class="col-md-3 milestone-col">
                        <div class="milestone">
                            <div style="font-weight: bold;" class="number" data-animation="true" data-animation-type="number" data-final-number="1417"></div>
                            <div style="color: #00acac;" class="title">Days Online</div>
                        </div>
                    </div>
                    <!-- end col-3 -->
                    <!-- begin col-3 -->
                    <div class="col-md-3 milestone-col">
                        <div class="milestone">
                            <div style="font-weight: bold;" class="number" data-animation="true" data-animation-type="number" data-final-number="77182">0</div>
                            <div style="color: #00acac;" class="title">Registered Members</div>
                        </div>
                    </div>
                    <!-- end col-3 -->
                    <!-- begin col-3 -->
                    <div class="col-md-3 milestone-col">
                        <div class="milestone">
                            ...
                            <div style="display: inline-block; font-weight: bold;" class="number" data-decimal-numbers="2" data-animation="true" data-animation-type="number" data-final-number="28302419.685">0</div>
                            <div style="color: #00acac;" class="title">Current Deposits</div>
                        </div>
                    </div>
                    <!-- end col-3 -->
                    <!-- begin col-3 -->
                    <div class="col-md-3 milestone-col">
                        <div class="milestone">
                            <span class="number" style="display: inline-block; font-weight: bold;">$ </span>
                            <div style="display: inline-block; font-weight: bold;" class="number" data-animation="true" data-animation-type="number" data-final-number="5970950.348"></div>
                            <div style="color: #00acac;" class="title">Total Withdrawals</div>
                        </div>
                    </div>
                    <!-- end col-3 -->
                </div>
        ...
        <div id="pricing" class="content" data-scrollview="true" style="background: #b4b4b4">
            <!-- begin container -->
            <div class="container">
                <h2 class="content-title">Our Investment Plans</h2>
                <p class="content-desc">
                    Depending on the amount of your investment, you can use one of the three investment plans. You can have several different plans under one account. </p>
                <!-- begin pricing-table -->
                <ul class="pricing-table pricing-col-3">
                        ...
                        <div class="pricing-container">
                            ...
                            <div class="price">
                                <div class="price-figure">
                                    <span class="price-number"><?php echo e($plan->increment_amount); ?>% <?php echo e($plan->increment_interval); ?></span>
                                    <span class="price-tenure">for <?php echo e($plan->expiration); ?></span>
                                </div>
                            </div>
                            <ul class="features" style="background: #cccccc; border: none;">
                                <li>Minimum deposit:
                                    <b><?php echo e($settings->currency); ?><?php echo e($plan->min_price); ?></b>
                                </li>
                                <li>Maximum deposit:
                                    <b><?php echo e($settings->currency); ?><?php echo e($plan->max_price); ?></b>
                                </li>
                                <li>Earnings paid
                                    <b>every 24h</b>
                                </li>
                            ...
                            <div class="footer">
                                <a href="register" class="btn btn-inverse btn-theme btn-block">Invest Now</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <!--        </ul>-->
                    <!--        <div class="footer">-->
                    <!--            <a href="register" class="btn btn-primary btn-theme btn-block">Invest Now</a>-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</li>-->
                    <!--<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
                    <!-- <li data-animation="true" data-animation-type="fadeInUp">
                        <div class="pricing-container">
                            ...
                            <div class="price">
                                <div class="price-figure">
                                    <span class="price-number">135% Daily</span>
                                    <span class="price-tenure">for 20 days</span>
                                </div>
                            </div>
                            <ul class="features" style="background: #cccccc; border: none;">
                                <li>Minimum deposit:
        ...
        <div id="quote" class="content bg-black-darker has-bg" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg" style="background-image: url(assets/img/bg/bg-002.jpg);" data-paroller="true" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01"></div>
            <!-- end content-bg -->
            <!-- begin container -->
                    ...
                    <div class="col-md-12 quote">
                        <div class="row justify-content-center">
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 col-3">
                                <img src="temp/custom/images/PerfectMoney.png" class="mw-100 mh-100 mt-2" style="opacity: 0.6">
                                <small style="font-size: 0.2em; margin-top: 5px">Perfect Money</small>
                            </div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 col-3">
                                <img src="temp/custom/images/Bitcoin.png" class="mw-100 mh-100 mt-2" style="opacity: 0.6">
                                <small style="font-size: 0.2em; margin-top: 5px">Bitcoin</small>
                            </div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 col-3">
                                <img src="temp/custom/images/Litecoin.png" class="mw-100 mh-100 mt-2" style="opacity: 0.6">
                                <small style="font-size: 0.2em; margin-top: 5px">Litecoin</small>
                            </div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 col-3">
                                <img src="temp/custom/images/Ethereum.png" class="mw-100 mh-100 mt-2" style="opacity: 0.6">
                                <small style="font-size: 0.2em; margin-top: 5px">Ethereum</small>
                            </div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 col-3">
                                <img src="temp/custom/images/Dogecoin.png" class="mw-100 mh-100 mt-2" style="opacity: 0.6">
                                <small style="font-size: 0.2em; margin-top: 5px">DogeCoin</small>
                            </div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 col-3">
                                <img src="temp/custom/images/Dash.png" class="mw-100 mh-100 mt-2" style="opacity: 0.5">
                                <small style="font-size: 0.2em; margin-top: 5px">Dash</small>
                            </div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 col-3">
                                <img src="temp/custom/images/Bitcoin%20Cash.png" class="mw-100 mh-100 mt-2" style="opacity: 0.5">
                                <small style="font-size: 0.2em; margin-top: 5px">Bitcoin Cash</small>
                            </div>
                        </div>
                    </div>
                    <!-- end col-12 -->
        ...
        <div id="service" class="content" data-scrollview="true" style="background: #b4b4b4">
            <!-- begin container -->
            <div class="container">
                <h2 class="content-title">What Makes Us Stand Out</h2>
                <p class="content-desc">
                    What makes our investment system distinguish us from others and is the best in the market?</p>
                <!-- begin row -->
                <div class="row">
                    <!-- begin col-4 -->
                    <div class="col-md-4 col-sm-12">
                        <div class="service">
                            ...
                            <div class="info">
                                <h4 class="title">Daily Income</h4>
                                <p class="desc">
                                    You will receive earnings every 24 hours on all days of the year. Your deposit is working all the time, even on weekends and holidays.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-4 -->
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="service">
                            ...
                            <div class="info">
                                <h4 class="title">Full Control of Investment</h4>
                                <p class="desc">You can cancel your deposit at any time and withdraw the funds. We will only charge you a 10% cancellation fee.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-4 -->
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">Your withdrawal will be processed by our operators as fast as possible. Maximum waiting time is up to 24 hours (7 days/week)</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-4 -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">By using <?php echo e($settings->site_name); ?> you have a guaranteed daily profit of 3% to 5% depending on the chosen investment plan.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-4 -->
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">We make every effort to ensure that your data and funds are 100% secured. We only use secure connections and top-class servers.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-4 -->
                    ...
                    <div class="col-md-4 col-sm-12 col-12">
                        <div class="service">
                            ...
                            <div class="info">
                                <h4 class="title">24/7 Live Support</h4>
                                <p class="desc">Our agents are available and always ready to help you on chat 24/7. You can also contact us via email or social media.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-4 -->
        ...
        <div id="action-box" class="pb-1 pt-4 content has-bg" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg" style="background-image: url(assets/img/bg/bg-action2.jpg)" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01">
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
            <div class="container" data-animation="true" data-animation-type="fadeInRight">
                ...
                <div class="row action-box justify-content-center">
                    ...
                    <div class="col-md-6 col-sm-12 col-12">
                        <h3 class="pb-2 d-none d-md-inline-block">REFERRAL PROGRAM</h3>
                        <h3 class="d-md-none pb-2 text-center">REFERRAL PROGRAM</h3>
                        <p class="text-justify desc">
                            With our referral program, you can earn money by advertising our system to others. Build the best team with us. We offer 3-level referral program with 5%-2%-1% commission.Try to convince as many people as possible, each new person is an additional income
                            for you. Send your referral link to companions, family and share them on online media. We will provide you with all the information and necessary advertising materials. Record a video showing how you invest, share proofs of
                            your payouts. We give you full freedom in advertising your reference link. The referral program earnings are unlimited, your structure can have a virtually infinite number of users, and your commissions will be paid immediately
                            upon receipt.</p>
                    </div>
                    <!-- end col-9 -->
                    <!-- begin col-3 -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="about">
                                ...
                                <div class="portfolio_list_img">
                                    <img src="temp/custom/images/about-one.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <!-- end about -->
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="about-author">
                                <!-- <h3 class="mb-3">Video Presentation</h3> -->
                                <div class="embed-responsive embed-responsive-16by9">
                                    <img src="temp/custom/images/about-two.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <!-- end about-author -->
                        </div>
        ...
        <div id="team" class="content" data-scrollview="true" style="background: #b4b4b4">
            <!-- begin container -->
            <div class="container">
                <h2 class="content-title">How to Use <?php echo e($settings->site_name); ?> ?</h2>
                <p class="content-desc">
                    Only 3 simple steps will allow you to invest and start earning with our guaranteed daily profit system. </p>
                <!-- begin row -->
                <div class="row">
                    <!-- begin col-4 -->
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="team">
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="temp/custom/images/iconf1a.png" width="128px" alt="step1">
                            </div>
                            <div class="info">
                                <h3 class="name">Register an Account</h3>
                                ...
                                <p>Registration takes about 2 min and is free. Your account will be active immediately.</p>
                            </div>
                        </div>
                        <!-- end team -->
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="team">
                            <div class="image" data-animation="true" data-animation-type="flipInY">
                                <img src="temp/custom/images/iconf2a.png" width="128px" alt="step2">
                            </div>
                            <div class="info">
                                <h3 class="name">Make a Deposit</h3>
                                <div class="title text-primary" style="background-color: #171717; padding: 3px; border-radius: 3px; width: 50%; margin-left: auto; margin-right: auto;">
                                    <b>STEP 2</b>
                                </div>
                                <p>The process is very simple. You can make a deposit using 7 available payment methods.</p>
                            </div>
                        </div>
                        <!-- end team -->
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="team">
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="temp/custom/images/iconf3a.png" width="128px" alt="step3">
                            </div>
                            <div class="info">
                                <h3 class="name">Enjoy your Profits</h3>
                                <div class="title text-primary" style="background-color: #171717; padding: 3px; border-radius: 3px; width: 50%; margin-left: auto; margin-right: auto;">
                                    <b>STEP 3</b>
                                </div>
                                <p>You will receive profit accruals every 24 hours after you made your deposit. 7 days in a week. </p>
                            </div>
                        </div>
                        <!-- end team -->
                    </div>
        ...
        <div id="client" class="pb-3 pt-4 content has-bg bg-green" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg" style="background-image: url(assets/img/bg/bg-faq.jpg)" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01">
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
            <div class="container" data-animation="true" data-animation-type="fadeInUp">
                ...
                <div class="row text-center">
                    <div class="col-md-6 text-white text-center align-items-center">
                        <div class="info">
                            <h4 class="h6 title text-left text-primary">Do I need any trading skills?</h4>
                            <p class="desc text-justify">
                                Absolutely not, our asset management system works in such a way that our traders manage your funds and professionally invest them, providing you with a guaranteed daily profit. This is 100% passive income, regardless of your knowledge or skills. </p>
                        </div>
                        <div class="info">
                            <h4 class="h6 title text-left text-primary">What minimum and maximum amount can I invest?</h4>
                            <p class="desc text-justify">
                                Minimum deposit amount: for the Basic plan it is $300, for the Premium plan it is $ 2,000, for the Supreme Plan is $ 10,000. If you make a deposit using cryptocurrencies, the declared amount will be converted at the current market exchange rate.</p>
                        </div>
                    </div>
                    <div class="col-md-6 text-white text-center align-items-center">
                        <div class="info">
                            <h4 class="h6 title text-left text-primary">How long do I have to wait for withdrawal?</h4>
                            <p class="desc text-justify">
                                The waiting time for withdrawal does not exceed 24 hours on all days of the year (including weekends and holidays). In our 24/7 work, our operators always make payouts as quickly as possible.</p>
                        </div>
                        <div class="info">
                            <h4 class="h6 title text-left text-primary">What is the minimum and maximum withdrawal amount?</h4>
                            <p class="desc text-justify">
                                Minimum withdrawal amount: for PerfectMoney is $2, for Cryptocurrencies: $500 There is no maximum withdrawal amount. If you make a withdrawal using cryptocurrencies amount will be converted at the current rate.</p>
                        </div>
                    </div>
                </div>
        ...
        <div id="contact" class="content" data-scrollview="true" style="background: #b4b4b4">
            ...
            <div class="container">
                ...
                <p class="content-desc">
                    If you have any questions about our company or need help with our service, please don't hesitate to contact us. We will reply as soon as possible.</p>
                <!-- begin row -->
                <div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-6" data-animation="true" data-animation-type="fadeInLeft">
                        <div class="row">
                            <div class="col-md-6 col-6">
                                <p> <strong><?php echo e($settings->site_name); ?> LTD.</strong><br> Texas<br> United States of America <br><a href="mailto:<?php echo e($settings->contact_email); ?>" class="text-primary"><?php echo e($settings->contact_email); ?></a>                                    <br><a href="#" class="text-primary">+<?php echo e($settings->	whatsapp); ?></a></p>
                            </div>
                            <div style="cursor: pointer" onclick="location.href='#';" class="col-md-6 col-6">
                                <div class="image" data-animation="true" data-animation-type="flipInY">
                                    <img src="temp/custom/images/press_icon.png" width="98px" alt="step2">
                        ...
                        <div class="row">
                            <div style="cursor: pointer" onclick="location.href='cert.html';" class="col-xl-4 col-md-4 col-sm-4 col-xs-4 col-4">
                                <img src="images/cert.png" width="97px">
                                <p class="mt-2"> Company Certificate </p>
                            </div>
                            <div style="cursor: pointer" onclick="location.href='#';" class="col-xl-4 col-md-4 col-sm-4 col-xs-4 col-4">
                    ...
                    <div class="col-md-6 form-col" data-animation="true" data-animation-type="fadeInRight">
                        <form class="form-horizontal">
                            <input type="hidden" name="form_id" value="16221599468399"><input type="hidden" name="form_token" value="cdceee648c4955b21c23d51465a59bae">
        ...
        <div id="footer" class="footer">
            <div class="container">
                <div class="footer-brand">
                    <img src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>" width="200px">
                </div>
                <p>
                    Copyright &copy; 2023 <?php echo e($settings->site_name); ?> LTD.<br> Please make payment directlly
                    <a href="#" target="_blank"> </a> to the company bitcoin address </p>
                <p class="social-list">
                    <a href="#"><i class="fab fa-telegram-plane fa-fw"></i></a>
                    <a href="#"><i class="fab fa-facebook-f fa-fw"></i></a>
                    <a href="#"><i class="fab fa-twitter fa-fw"></i></a>
                    <a href="#"><i class="fab fa-instagram fa-fw"></i></a>
                    <a href="#"><i class="fab fa-youtube fa-fw"></i></a> </p>
            </div>
        </div>
        <!-- end #footer -->
        <!-- begin theme-panel -->
        <div class="theme-panel">
            <div class="theme-panel-content">
                <ul class="theme-list clearfix">
                    <li>
                        <a href="javascript:;" class="bg-red" data-theme="red" data-theme-file="assets/css/one-page-parallax/theme/red.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Red" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-pink" data-theme="pink" data-theme-file="assets/css/one-page-parallax/theme/pink.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Pink" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-orange" data-theme="orange" data-theme-file="assets/css/one-page-parallax/theme/orange.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Orange" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-yellow" data-theme="yellow" data-theme-file="assets/css/one-page-parallax/theme/yellow.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Yellow" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-lime" data-theme="lime" data-theme-file="assets/css/one-page-parallax/theme/lime.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Lime" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-green" data-theme="green" data-theme-file="assets/css/one-page-parallax/theme/green.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Green" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li class="active">
                        <a href="javascript:;" class="bg-teal" data-theme-file="assets/css/one-page-parallax/theme/teal.min.css" data-theme="default" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Default" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-aqua" data-theme="aqua" data-theme-file="assets/css/one-page-parallax/theme/aqua.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Aqua" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-blue" data-theme="blue" data-theme-file="assets/css/one-page-parallax/theme/blue.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Blue" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-purple" data-theme="purple" data-theme-file="assets/css/one-page-parallax/theme/purple.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Purple" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-indigo" data-theme="indigo" data-theme-file="assets/css/one-page-parallax/theme/indigo.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Indigo" data-original-title="" title="">&nbsp;</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="bg-black" data-theme="black" data-theme-file="assets/css/one-page-parallax/theme/black.min.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Black" data-original-title="" title="">&nbsp;</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!-- end #page-container -->
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="temp/custom/assets/js/one-page-parallax/app.min.js"></script>
...
<script data-cfasync="false" src="https://cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.html"></script><script type="text/javascript">
...
<script type="text/javascript">
        ...
        <script type="text/javascript" src="https://translate_a/elementa0d8.js?cb=googleTranslateElementInit"></script>

    </body>



</html><?php /**PATH /home/remedyfinance/public_html/demo3.remedyfinance.online/resources/views/home/index.blade.php ENDPATH**/ ?>