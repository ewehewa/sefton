                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <select name="income" id="income" class="pl-10 block w-full py-2 pr-3 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500 sm:text-sm" required>
                                        ...
                                        <option value="<?php echo e(Auth::user()->s_curr); ?>100.00 - <?php echo e(Auth::user()->s_curr); ?>500.00"><?php echo e(Auth::user()->s_curr); ?>100.00 - <?php echo e(Auth::user()->s_curr); ?>500.00</option> 
                                        <option value="<?php echo e(Auth::user()->s_curr); ?>700.00 - $1,000.00"><?php echo e(Auth::user()->s_curr); ?>700.00 - $1,000.00</option> 
                                        ...
                                        <option value="$150,000.00 - <?php echo e(Auth::user()->s_curr); ?>300,000.00">$150,000.00 - <?php echo e(Auth::user()->s_curr); ?>300,000.00</option> 
                                        <option value="<?php echo e(Auth::user()->s_curr); ?>300,000.00 - $1,000,000.00"><?php echo e(Auth::user()->s_curr); ?>300,000.00 - $1,000,000.00</option> 
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    function setupFileUpload(fileId, previewId, nameId, previewContainerId, removeId, labelId, iconId) {
        ...
        container.addEventListener('drop', function(e) {
            ...
            if (files.length) {
                ...
                if (files[0] && !validateFileSize(files[0], 2)) {
                    return;
                }
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home8/globalch/public_html/auth/resources/views/user/verification.blade.php ENDPATH**/ ?>