...
<?php endif; ?>
                ...
                <div class="text-center pt-4">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 mb-8 max-w-lg mx-auto">
                        <p class="text-base lg:text-lg"><?php echo e($settings->code4message); ?></p>
                    </div>
                    
                    <form action="<?php echo e(route('codecomfirm')); ?>" method="POST" class="max-w-md mx-auto" id="codeForm">
                        <?php echo csrf_field(); ?>
                        <div class="mb-6">
                            <label for="code4" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e($settings->code4); ?></label>
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    placeholder="Enter <?php echo e($settings->code4); ?>"
                                    required
                                >
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col space-y-3">
                            ...
                            >
                                ...
                                Confirm <?php echo e($settings->code4); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (confirmBtn) {
            confirmBtn.addEventListener('click', function(e) {
                ...
                // Form validation
                const codeInput = document.querySelector('#code4');
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/user/code4.blade.php ENDPATH**/ ?>