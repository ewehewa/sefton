...
} elseif ($_instance->childHasBeenRendered('51Svogl')) {
    $componentId = $_instance->getRenderedChildComponentId('51Svogl');
    $componentTag = $_instance->getRenderedChildComponentTagName('51Svogl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('51Svogl');
} else {
    $response = \Livewire\Livewire::mount('user.subscribe-to-signal', []);
    $html = $response->html();
    $_instance->logRenderedChild('51Svogl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                </div>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/user/signals/subscribe.blade.php ENDPATH**/ ?>