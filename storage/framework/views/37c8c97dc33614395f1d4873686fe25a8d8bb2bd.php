...
<?php $__env->startSection('title', 'Withdrawal Status Update'); ?>
<?php $__env->startSection('subtitle', $withdrawal->status == 'Processed' ? 'Your withdrawal has been successfully completed' : 'Your withdrawal is being processed'); ?>
<?php $__env->startSection('company_name', $settings->site_name); ?>

<?php $__env->startSection('greeting', 'Dear ' . ($foramin ? 'Administrator' : $user->name)); ?>
...
<div style="background: linear-gradient(135deg, #3B82F6 0%, #1D4ED8 100%); border-radius: 12px; padding: 25px; margin: 25px 0; text-align: center; box-shadow: 0 10px 25px rgba(59, 130, 246, 0.2);">
    ...
    <div style="color: white; font-size: 28px; font-weight: 700; margin-bottom: 5px;"><?php echo e($settings->currency); ?><?php echo e(number_format($withdrawal->amount, 2)); ?></div>
    <div style="color: rgba(255, 255, 255, 0.9); font-size: 13px;"><?php echo e(\Carbon\Carbon::parse($withdrawal->created_at)->format('M d, Y \a\t g:i A')); ?></div>
</div>
...
<div style="background: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 10px; padding: 20px; margin-bottom: 25px;">
    ...
    <p style="margin: 0; color: #334155; line-height: 1.6;"><?php echo e($user->name); ?> has requested a withdrawal of <span style="font-weight: 600; color: #1E40AF;"><?php echo e($settings->currency); ?><?php echo e(number_format($withdrawal->amount, 2)); ?></span> to <?php echo e($withdrawal->accountname); ?> (<?php echo e($withdrawal->bankname); ?>). Please review this transaction.</p>
</div>
<?php else: ?>
    <?php if($withdrawal->status == 'Processed'): ?>
    <!-- Success Message -->
    <div style="background: #F8FAFC; border: 1px solid #E2E8F0; border-left: 4px solid #3B82F6; border-radius: 10px; padding: 20px; margin-bottom: 25px;">
        ...
        <p style="margin: 0; color: #334155; line-height: 1.6;">Your withdrawal of <span style="font-weight: 600; color: #1E40AF;"><?php echo e($settings->currency); ?><?php echo e(number_format($withdrawal->amount, 2)); ?></span> has been successfully processed and sent to <?php echo e($withdrawal->accountname); ?> at <?php echo e($withdrawal->bankname); ?>.</p>
    </div>
    <?php else: ?>
    <!-- Processing Message -->
    <div style="background: #F8FAFC; border: 1px solid #E2E8F0; border-left: 4px solid #60A5FA; border-radius: 10px; padding: 20px; margin-bottom: 25px;">
        ...
        <p style="margin-bottom: 8px; color: #334155; line-height: 1.6;">Your withdrawal of <span style="font-weight: 600; color: #1E40AF;"><?php echo e($settings->currency); ?><?php echo e(number_format($withdrawal->amount, 2)); ?></span> to <?php echo e($withdrawal->accountname); ?> at <?php echo e($withdrawal->bankname); ?> is being processed.</p>
...
<div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); margin: 30px 0; border: 1px solid #E2E8F0;">
    <div style="background: linear-gradient(90deg, #1E40AF 0%, #3B82F6 100%); color: white; padding: 18px; position: relative;">
        ...
        <p style="margin: 4px 0 0 30px; opacity: 0.8; font-size: 13px;">Reference: #<?php echo e($withdrawal->id ?? str_pad($withdrawal->id ?? '001', 6, '0', STR_PAD_LEFT)); ?></p>
    </div>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <tbody>
            <tr style="background: #FAFBFC;">
                ...
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; color: #1F2937; font-family: monospace; letter-spacing: 0.5px;"><?php echo e($withdrawal->accountnumber); ?></td>
            </tr>
            <tr style="background: white;">
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; font-weight: 600; color: #374151;">Account Holder</td>
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; color: #1F2937;"><?php echo e($withdrawal->accountname); ?></td>
            </tr>
            <tr style="background: #FAFBFC;">
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; font-weight: 600; color: #374151;">Bank Name</td>
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; color: #1F2937;"><?php echo e($withdrawal->bankname); ?></td>
            </tr>
            <tr style="background: white;">
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; font-weight: 600; color: #374151;">Description</td>
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; color: #1F2937;"><?php echo e($withdrawal->Description); ?></td>
            </tr>
            <tr style="background: #FAFBFC;">
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; font-weight: 600; color: #374151;">Transaction Date</td>
                <td style="padding: 16px 20px; border-bottom: 1px solid #E2E8F0; color: #1F2937;"><?php echo e(\Carbon\Carbon::parse($withdrawal->created_at)->format('l, F j, Y \a\t g:i A')); ?></td>
            </tr>
            <tr style="background: #EFF6FF;">
                <td style="padding: 18px 20px; border-bottom: 1px solid #BFDBFE; font-weight: 700; color: #1E40AF;">Withdrawal Amount</td>
                <td style="padding: 18px 20px; border-bottom: 1px solid #BFDBFE; color: #1E3A8A; font-weight: 700; font-size: 16px;"><?php echo e($settings->currency); ?><?php echo e(number_format($withdrawal->amount, 2)); ?></td>
            </tr>
            <tr style="background: #F0F9FF;">
                <td style="padding: 18px 20px; font-weight: 700; color: #1E40AF;">Available Balance</td>
                <td style="padding: 18px 20px; color: #1E3A8A; font-weight: 700; font-size: 16px;"><?php echo e($settings->currency); ?><?php echo e(number_format($withdrawal->bal, 2)); ?></td>
            </tr>
        </tbody>
    </table>
</div>
...
<div style="text-align: center; margin: 30px 0;">
    <a href="<?php echo e(url('/dashboard/transactions')); ?>" style="display: inline-block; background: linear-gradient(135deg, #3B82F6 0%, #1D4ED8 100%); color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 0 8px; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3);">View Transactions</a>
    <a href="<?php echo e(url('/dashboard')); ?>" style="display: inline-block; background: #64748B; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 0 8px;">Dashboard</a>
</div>
<?php endif; ?>
...
<div style="background: #F8FAFC; border-radius: 12px; padding: 25px; margin-top: 30px; border: 1px solid #E2E8F0;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 15px;">
        ...
        <div style="flex: 1; min-width: 180px; background: white; border-radius: 10px; padding: 16px; border: 1px solid #E2E8F0; text-align: center;">
            ...
            <a href="mailto:<?php echo e($settings->contact_email); ?>" style="color: #3B82F6; font-weight: 500; text-decoration: none; font-size: 13px;"><?php echo e($settings->contact_email); ?></a>
        </div>
        ...
        <div style="flex: 1; min-width: 180px; background: white; border-radius: 10px; padding: 16px; border: 1px solid #E2E8F0; text-align: center;">
            ...
            <a href="<?php echo e(url('/help')); ?>" style="color: #3B82F6; font-weight: 500; text-decoration: none; font-size: 13px;">Visit Help Center</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('emails.email-template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/emails/withdrawal-status.blade.php ENDPATH**/ ?>