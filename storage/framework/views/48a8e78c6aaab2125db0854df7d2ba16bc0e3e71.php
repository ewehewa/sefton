...
} elseif ($_instance->childHasBeenRendered('tNvfcyk')) {
    $componentId = $_instance->getRenderedChildComponentId('tNvfcyk');
    $componentTag = $_instance->getRenderedChildComponentTagName('tNvfcyk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tNvfcyk');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('tNvfcyk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('sNSbEwU')) {
    $componentId = $_instance->getRenderedChildComponentId('sNSbEwU');
    $componentTag = $_instance->getRenderedChildComponentTagName('sNSbEwU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sNSbEwU');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('sNSbEwU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teliocec/online.fairwayassetmanagementltd.com/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>