...
<?php endif; ?>
    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-white/20 dark:border-gray-700/50 overflow-hidden">
        ...
        <!-- Form Content -->
        <div class="p-4">
            <form action="<?php echo e(route('enquiry')); ?>" method="post" class="space-y-4">
                <?php echo csrf_field(); ?>
    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-white/20 dark:border-gray-700/50 overflow-hidden">
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-700" x-data="{ expandedItem: null }">
            ...
            <?php $__currentLoopData = $quickHelp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $help): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-4">
                <button @click="expandedItem = expandedItem === <?php echo e($index); ?> ? null : <?php echo e($index); ?>" class="w-full flex items-start justify-between text-left">
                    <div class="flex items-start space-x-3 flex-1">
                        <div class="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="<?php echo e($help['icon']); ?> text-gray-600 dark:text-gray-400 text-sm"></i>
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($help['question']); ?></p>
                            <div x-show="expandedItem === <?php echo e($index); ?>" 
                                 x-transition:enter="transition ease-out duration-200" 
                                 x-transition:enter-start="opacity-0 -translate-y-1" 
                                 x-transition:enter-end="opacity-100 translate-y-0" 
                                 class="mt-2">
                                <p class="text-xs text-gray-600 dark:text-gray-300 leading-relaxed"><?php echo e($help['answer']); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="ml-2 flex-shrink-0">
                        <i x-show="expandedItem !== <?php echo e($index); ?>" class="fa-solid fa-chevron-down text-gray-400 text-xs"></i>
                        <i x-show="expandedItem === <?php echo e($index); ?>" class="fa-solid fa-chevron-up text-gray-400 text-xs"></i>
                    </div>
                </button>
            </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/support.blade.php ENDPATH**/ ?>