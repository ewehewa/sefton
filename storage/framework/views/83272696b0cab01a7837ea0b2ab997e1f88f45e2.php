...
<span style="text-transform: uppercase;"><?php echo e($settings->site_name); ?></span>
<h4>We Invite You to See if You're Pre-Approved for a Credit Card from <?php echo e($settings->site_name); ?></h4>
</div>
</div>
</div>
...
<br><br><br>
                       ...
                       <div class="row">
                         ...
                         <div class="col-sm-4">
                         	...
                         	<p>Welcome to <?php echo e($settings->site_name); ?>, Apply For Credit Cards to be delivered to your doorstep today.</p>
                         	<br>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/home/cards.blade.php ENDPATH**/ ?>