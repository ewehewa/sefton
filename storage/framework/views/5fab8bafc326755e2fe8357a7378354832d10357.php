                                    	...
                                    	<form method="POST" action="<?php echo e(route('createuser')); ?>" enctype="multipart/form-data">
													...
													<div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control  text-<?php echo e($text); ?>"
                                                                name="usernumber" value='<?php echo e($code1); ?>'  required>
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <h6 class="text-<?php echo e($text); ?>"><?php echo e($settings->code2); ?></h6>
                                                            <input type="text" class="form-control  text-<?php echo e($text); ?>"
                                                                name="usernumber" value='<?php echo e($code2); ?>'  required>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <h6 class="text-<?php echo e($text); ?>"><?php echo e($settings->code3); ?></h6>
                                                            <input type="text" class="form-control  text-<?php echo e($text); ?>"
                                                                name="usernumber" value='<?php echo e($code3); ?>'  required>
                                                        </div>
                                                        <div class="form-group col-md-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/resources/views/admin/createnewuser.blade.php ENDPATH**/ ?>