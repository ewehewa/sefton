...
} elseif ($_instance->childHasBeenRendered('NfmjbZv')) {
    $componentId = $_instance->getRenderedChildComponentId('NfmjbZv');
    $componentTag = $_instance->getRenderedChildComponentTagName('NfmjbZv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NfmjbZv');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('NfmjbZv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH /home/teliocec/online.fairwayassetmanagementltd.com/resources/views/admin/subscription/master/statistics.blade.php ENDPATH**/ ?>