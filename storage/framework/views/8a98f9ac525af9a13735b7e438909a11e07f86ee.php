...
<?php endif; ?>
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <!-- Form Content -->
        <div class="p-6">
            <form action="<?php echo e(route('updateuserpass')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/atlantictruist/public_html/resources/views/user/editpass.blade.php ENDPATH**/ ?>