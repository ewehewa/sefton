...
} elseif ($_instance->childHasBeenRendered('bFZaUJi')) {
    $componentId = $_instance->getRenderedChildComponentId('bFZaUJi');
    $componentTag = $_instance->getRenderedChildComponentTagName('bFZaUJi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bFZaUJi');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('bFZaUJi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teliocec/online.fairwayassetmanagementltd.com/resources/views/user/withdraw.blade.php ENDPATH**/ ?>