    ...
    <div class="max-w-8xl mx-auto">
        ...
        <div class="hidden lg:block mb-4">
            ...
            validateAmount() {
                ...
                const minTransfer = <?php echo e(Auth::user()->min_transfer_amount ?? 1); ?>;
                const maxTransfer = <?php echo e(Auth::user()->max_transfer_amount ?? 500000); ?>;
            ...
            getTransferLimits() {
                return {
                    min: <?php echo e(Auth::user()->min_transfer_amount ?? 1); ?>,
                    max: <?php echo e(Auth::user()->max_transfer_amount ?? 500000); ?>

                };
            },

            getMaxBalance() {
                return <?php echo e(Auth::user()->account_bal); ?>;
            },
            ...
            <div class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="p-4 lg:p-6 space-y-6">
                    ...
                    <div x-data="quickTransfer()" x-init="loadBeneficiaries()">
                        <?php echo $__env->make('partials.quick-transfer', ['transferType' => 'local', 'methodType' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                        ...
                        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-lg">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->curr); ?> Currency</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-1">
                                <div class="flex items-baseline space-x-1">
                                    <span class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format(Auth::user()->account_bal, 2, '.', ',')); ?></span>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-gray-50/80 to-white/80 dark:from-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-4">
                            ...
                            <div class="relative mb-4">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                                    <span class="text-gray-400 dark:text-gray-500 text-xl font-bold"><?php echo e(Auth::user()->s_curr); ?></span>
                                </div>
                                <input
                                    type="number"
                                    name="amount"
                            ...
                            <div class="mt-6 p-4 bg-primary-50/50 dark:bg-primary-900/20 rounded-xl border border-primary-200/50 dark:border-primary-700/50" x-show="amount && parseFloat(amount) > 0">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">Transfer amount: <span class="font-semibold text-gray-900 dark:text-white" x-text="'<?php echo e(Auth::user()->s_curr); ?>' + parseFloat(amount).toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + ' <?php echo e(Auth::user()->curr); ?>'"></span></p>
                            </div>
                            ...
                            <div class="mt-4 p-3 bg-gray-50/80 dark:bg-gray-800/80 rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                                ...
                                <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
                                    <span>Minimum: <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format(Auth::user()->min_transfer_amount ?? 1, 2)); ?></span></span>
                                    <span>Maximum: <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format(Auth::user()->max_transfer_amount ?? 500000, 2)); ?></span></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/user/localtransfer.blade.php ENDPATH**/ ?>