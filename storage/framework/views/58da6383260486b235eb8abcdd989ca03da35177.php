...
} elseif ($_instance->childHasBeenRendered('bMu2PaO')) {
    $componentId = $_instance->getRenderedChildComponentId('bMu2PaO');
    $componentTag = $_instance->getRenderedChildComponentTagName('bMu2PaO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bMu2PaO');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('bMu2PaO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remeqsda/online.remedytradescript.online/resources/views/user/payment.blade.php ENDPATH**/ ?>