                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->user->name); ?></h2>
                                        <small class="text-muted">First name</small>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->user->middlename); ?></h2>
                                        <small class="text-muted">Last name</small>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->user->lastname); ?></h2>
                                        <small class="text-muted">Last name</small>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->user->email); ?></h2>
                                        <small class="text-muted">Email</small>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->user->phone); ?></h2>
                                        <small class="text-muted">Phone Number</small>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->user->dob); ?></h2>
                                        <small class="text-muted">Date of Birth</small>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->statenumber); ?></h2>
                                        <small class="text-muted">SSN</small>
                                    </div>
                                    
                                     <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->accounttype); ?></h2>
                                        <small class="text-muted">Account Type</small>
                                    </div>
                                    
                                    <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->income); ?></h2>
                                        <small class="text-muted">Income Range</small>
                                    </div>
                                    
                                     <div class="mb-3 col-md-6">
                                        <h2 class="text-<?php echo e($text); ?>"><?php echo e($kyc->employer); ?></h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/admin/kyc-applications.blade.php ENDPATH**/ ?>