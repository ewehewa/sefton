...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.pay-alert','data' => []]); ?>
<?php $component->withName('pay-alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class=""https://demo3.remedyfinance.online/>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-body bg-primary">
                                    <div class="row">
                                        <div class="col">
                                            <h6 class="mb-1  text-white">You are Required to Pay Tax Fee of</h6>
                                            <span
                                                class="mb-0 h5 font-weight-bold text-white"><?php echo e($settings->currency); ?><?php echo e(number_format(Auth::user()->bonus, 2, '.', ',')); ?></span>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-body bg-warning">
                                    <div class="row">
                                        <div class="col">
                                            <h6 class="mb-1  text-white">Upgrade requirement</h6>
                                            <h6 class="mb-1  text-white">YOU ARE REQUIRED TO MAKE AN ACCOUNT UPGRADE OF ( <?php echo e($settings->currency); ?><?php echo e(Auth::user()->amount); ?>)</h6>
                        ...
                        <?php endif; ?>
                         <?php if(Auth::user()->signalstatus =='Yes'): ?>
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-stats">
                                <!-- Card body -->
                                <div class="card-body bg-success">
                                    <div class="row">
                                        <div class="col">
                                            <h6 class="mb-1  text-white"><?php echo e(Auth::user()->signalname); ?> Signal Payment</h6>
                                            <h6 class="mb-1  text-white">YOU ARE REQUIRED TO PAY FOR <?php echo e(Auth::user()->signalname); ?>-<?php echo e(Auth::user()->signalamount); ?><?php echo e($settings->currency); ?>  </h6>
                                            <p> <a href="<?php echo e(route('deposits')); ?>" class='btn btn-warning'>Pay Now</a></p>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/public_html/demo3.remedyfinance.online/resources/views/user/dashboard.blade.php ENDPATH**/ ?>