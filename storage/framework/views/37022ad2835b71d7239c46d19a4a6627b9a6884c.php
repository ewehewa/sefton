...
} elseif ($_instance->childHasBeenRendered('hFBJbxQ')) {
    $componentId = $_instance->getRenderedChildComponentId('hFBJbxQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('hFBJbxQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hFBJbxQ');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('hFBJbxQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/demo.remedyfinance.online/resources/views/user/payment.blade.php ENDPATH**/ ?>