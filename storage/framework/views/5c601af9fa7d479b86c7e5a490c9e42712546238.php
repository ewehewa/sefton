                    ...
                    <div class="mb-5 row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="p-3 text-center">
                                ...
                                <p>To comply with regulation, each participant will have to go through indentity verification (AML) to prevent fraud causes.</p>
                            </div>
                            <div class="p-2 text-center shadow-lg p-md-5">
                                ...
                                <p>Your account is currently under reveiw</p>
                                <?php else: ?>
		<div class="row">
            <div class="col-lg-12">
...
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedycodes/public_html/fin.remedycodes.online/resources/views/user/verify.blade.php ENDPATH**/ ?>