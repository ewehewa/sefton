                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mb-3">
                                  <h5>  <label for="exampleInputEmail1">Code 4</label></h5>
                                    <input class="form-control" type="text"  name="code4" value="<?php echo e($settings->code4); ?>"  placeholder="Enter code4 name">
                                </div>
                                <div class="form-group col-md-6 mb-3">
                                  <h5>  <label for="exampleInputEmail1">Code 5</label></h5>
                                    <input class="form-control" type="text"  name="code5" value="<?php echo e($settings->code5); ?>"  placeholder="Enter code5 name">
                                </div>
                            </div>
                                 <div class="row">
                                    <div class="form-group col-md-4 mb-3">
                                 ...
                                 <div class="row">
                                    <div class="form-group col-md-6 mb-3">
                                      ...
                                      <textarea name="code4message" class="form-control " rows="2"><?php echo e($settings->code4message); ?></textarea>
                                      <small class="text-<?php echo e($text); ?>">This message will be displayed to users on if code4 is on international transfer</small>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
                                      <h5>  <label for="exampleInputEmail1">Code 5 Message</label></h5>
                                      <textarea name="code5message" class="form-control " rows="2"><?php echo e($settings->code5message); ?></textarea>
                                      <small class="text-<?php echo e($text); ?>">This message will be displayed to users on if code5 is on international transfer</small>
                                    </div>
                                 </div>
                                 <div class="row">
                                <div class="form-group col-md-4 mb-3">
                                    ...
                                    <div class="selectgroup">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="code4status" value="1" class="selectgroup-input"
                                                <?php echo e($settings->code4status == '1' ? 'checked' : ''); ?>>
                                            <span class="selectgroup-button">On</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="code4status"
                                                <?php echo e($settings->code4status != '1' ? 'checked' : ''); ?> value="0"
                                                class="selectgroup-input">
                                            <span class="selectgroup-button">Off</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="selectgroup">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="code5status" value="1" class="selectgroup-input"
                                                <?php echo e($settings->code5status == '1' ? 'checked' : ''); ?>>
                                            <span class="selectgroup-button">On</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="code5status"
                                                <?php echo e($settings->code5status != '1' ? 'checked' : ''); ?> value="0"
                                                class="selectgroup-input">
                                            <span class="selectgroup-button">Off</span>
                                        </label>
                                    </div>
...
</main><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/admin/Settings/AppSettings/transfercodes.blade.php ENDPATH**/ ?>