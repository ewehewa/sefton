...
} elseif ($_instance->childHasBeenRendered('F5kb3xE')) {
    $componentId = $_instance->getRenderedChildComponentId('F5kb3xE');
    $componentTag = $_instance->getRenderedChildComponentTagName('F5kb3xE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F5kb3xE');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('F5kb3xE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\remedybank\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>