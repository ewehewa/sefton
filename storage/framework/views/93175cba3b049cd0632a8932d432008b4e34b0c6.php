    ...
    <div class="md:hidden h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-black text-gray-900 dark:text-white flex flex-col overflow-hidden">
        ...
        <div class="flex flex-col items-center justify-center mt-10 px-6 py-4">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-gray-600 dark:text-gray-300 text-sm"><?php echo e(Auth::user()->name); ?></p>
            </div>
        ...
        <div class="flex-1 flex items-center justify-center p-12">
            <div class="w-full max-w-md desktop-pin-container rounded-3xl p-8 shadow-2xl">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 dark:text-gray-300"><?php echo e(Auth::user()->name); ?></p>
                </div>
                ...
                <div class="mt-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
                    <div class="flex items-center text-sm text-red-600 dark:text-red-400">
                        ...
                        <div>
                            ...
                            <a href="mailto:<?php echo e($settings->contact_email); ?>" class="inline-flex items-center mt-2 text-red-700 dark:text-red-300 hover:text-red-800 dark:hover:text-red-200">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/pin.blade.php ENDPATH**/ ?>