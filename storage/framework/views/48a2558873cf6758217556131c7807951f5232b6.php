...
} elseif ($_instance->childHasBeenRendered('LkQBc2h')) {
    $componentId = $_instance->getRenderedChildComponentId('LkQBc2h');
    $componentTag = $_instance->getRenderedChildComponentTagName('LkQBc2h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LkQBc2h');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('LkQBc2h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('X6khV7b')) {
    $componentId = $_instance->getRenderedChildComponentId('X6khV7b');
    $componentTag = $_instance->getRenderedChildComponentTagName('X6khV7b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('X6khV7b');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('X6khV7b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remeqsda/online.remedytradescript.online/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>