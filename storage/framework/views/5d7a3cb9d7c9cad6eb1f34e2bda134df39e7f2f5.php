        ...
        function generatePDF() {
            try {
                ...
                html2canvas(element, {
                    ...
                    // Save the PDF
                    pdf.save('account_statement_<?php echo e(date('Y-m-d_His')); ?>.pdf');
...
<body>
    ...
    <div class="page <?php echo e($statementStyle); ?>">
        <!-- Watermark -->
        <div class="watermark">
            <div class="watermark-logo"><?php echo e($settings->site_name); ?></div>
        </div>
        ...
        <div class="header">
            <div class="logo-container">
                <div>
                    ...
                    <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" class="logo" alt="Logo">
                    <?php else: ?>
                    <h2 style="margin: 0;"><?php echo e($settings->site_name); ?></h2>
                    <?php endif; ?>
                </div>
                <div style="text-align: right; font-size: 12px; color: #4b5563;">
                    <p style="margin: 0;"><?php echo e($settings->address ?? ''); ?></p>
                    <p style="margin: 0;">
                        <svg class="icon" width="16" height="16"><use xlink:href="#icon-mail"/></svg>
                        <?php echo e($settings->site_email); ?>
            ...
            <div class="card">
                ...
                <div class="account-info">
                    <div class="account-details">
                        ...
                        <p><strong>Account Number:</strong> <span class="account-number"><?php echo e($user->account_no); ?></span></p>
                    ...
                    <div class="statement-period">
                        ...
                        <p><?php echo e(\Carbon\Carbon::parse($dateFrom)->format('F d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($dateTo)->format('F d, Y')); ?></p>
                        <?php else: ?>
                        ...
                        <p><?php echo e($user->accounttype ?? 'Standard Account'); ?></p>
                    </div>
                </div>
                ...
                <div class="summary-section">
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <div class="summary-item-value"><?php echo e($settings->currency); ?><?php echo e(number_format($openingBalance, 2)); ?></div>
                        </div>
                        <div class="summary-item">
                            ...
                            <div class="summary-item-value credit"><?php echo e($settings->currency); ?><?php echo e(number_format($totalCredits, 2)); ?></div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-item-title">
                            ...
                            <div class="summary-item-value debit"><?php echo e($settings->currency); ?><?php echo e(number_format($totalDebits, 2)); ?></div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-item-title">CLOSING BALANCE</div>
                            <div class="summary-item-value"><?php echo e($settings->currency); ?><?php echo e(number_format($closingBalance, 2)); ?></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo e(\Carbon\Carbon::parse($transaction->created_at)->format('M d, Y')); ?></td>
                                    <td><?php echo e($transaction->Description); ?></td>
                                    <td><?php echo e($transaction->txn_id); ?></td>
                                    <td>
                                        <svg class="icon" width="14" height="14"><use xlink:href="<?php echo e($iconRef); ?>"/></svg>
                                        <?php echo e($transaction->type); ?>

                                    </td>
                                    <td><?php echo e($transaction->status); ?></td>
                                    <td class="<?php echo e($amountClass); ?>"><?php echo e($amountPrefix); ?> <?php echo e($settings->currency); ?><?php echo e(number_format($transaction->amount, 2)); ?></td>
                                    <td><?php echo e($settings->currency); ?><?php echo e(number_format($runningBalance, 2)); ?></td>
                                </tr>
        ...
        <div class="stamp">
            <div class="stamp-inner">
                ...
                <div><?php echo e($settings->site_name); ?></div>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p>Please contact our customer support at <?php echo e($settings->contact_email ?? $settings->site_email); ?> if you have any questions about this statement.</p>
            <p>All figures are shown in <?php echo e($settings->s_currency); ?>. This document serves as an official record of your account transactions.</p>
            <p><?php echo e($settings->site_name); ?> &copy; <?php echo e(date('Y')); ?> All rights reserved</p>
        </div>
        
        <div class="page-number">Page 1 of 1</div>
    </div>
</body>
</html> <?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/pdfs/statement.blade.php ENDPATH**/ ?>