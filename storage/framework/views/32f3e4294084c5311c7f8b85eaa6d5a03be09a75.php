                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-2 text-yellow-700 dark:text-yellow-400 text-sm">
                                            <p>Hi <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->lastname); ?>, your <?php echo e($settings->site_name); ?> internet banking account is currently Under Review. Our team is reviewing your information, and this process typically takes 24-48 hours.</p>
                    ...
                    <?php else: ?>
                        ...
                        <div class="bg-white/80 dark:bg-gray-700/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-lg p-4 mb-4">
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Welcome to <?php echo e($settings->site_name); ?></h2>
                            ...
                            <div class="prose prose-sm max-w-none text-gray-600 dark:text-gray-400 mb-4 text-sm">
                                <p class="mb-2"><strong class="text-gray-900 dark:text-white">Dear <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->lastname); ?> <?php echo e(Auth::user()->middlename); ?>,</strong></p>
                                
                                <p>Welcome Onboard! <?php echo e($settings->site_name); ?> is the market's most innovative and fastest-growing company in the financial industry. We look forward to working with you to help you get the most out of our financial services and realize your banking goals.</p>
                                
                                <p>Here at <?php echo e($settings->site_name); ?>, we are committed to providing a wide variety of savings, investment, and loan products, all designed to meet your specific needs. Our services are being used by over two million customers around the world.</p>
                                
                                <p>Our excellent customer support team is available 24/7 to help you with any questions. You can contact them at: <a href="mailto:<?php echo e($settings->contact_email); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300"><?php echo e($settings->contact_email); ?></a>.</p>
                        ...
                        <div class="bg-gray-50/80 dark:bg-gray-700/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-lg p-4">
                            ...
                            <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-lg p-3 h-64 overflow-y-auto text-sm text-gray-700 dark:text-gray-300 mb-4">
                                ...
                                <ul class="list-disc pl-6 mb-4 space-y-1">
                                    ...
                                    <li><span class="font-medium"><?php echo e($settings->site_name); ?> ACCOUNT NUMBER, PASSWORD and ACCOUNT PIN:</span> you choose to identify yourself when you use our online service.</li>
                                ...
                                <ol class="list-alpha pl-6 mb-4 space-y-2">
                                    ...
                                    <li><?php echo e($settings->site_name); ?> does not accept responsibility for any loss you or anybody else may suffer because any instructions or information you sent us are sent in error, fail to reach us or are distorted unless you have been the victim of fraud.</li>
                                    <li><?php echo e($settings->site_name); ?> does not accept responsibility for any loss you or anybody else may suffer because any instructions or information we send you fail to reach you or are distorted unless you have been the victim of fraud.</li>
                                </ol>
                                
                                <h4 class="font-semibold text-gray-900 dark:text-white mt-4 mb-2">5. HOW WE CAN CHANGE THESE CONDITIONS</h4>
                                <ol class="list-alpha pl-6 mb-4 space-y-2">
                                    <li><?php echo e($settings->site_name); ?> may change these conditions for any reason by giving you written notice or publishing the change on our website.</li>
                                ...
                                <p><?php echo e($settings->site_name); ?> service is available to you if you are 18 years of age or over.</p>
                            </div>
                            
                            <div class="flex flex-col sm:flex-row gap-3 justify-center sm:justify-start">
                                <a href="<?php echo e(route('kycform')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200">
                                    <i class="fas fa-check-circle mr-2 text-xs"></i>
                                    I Accept & Proceed to Verification
                                </a>
                                
                                <a href="<?php echo e(route('logout')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
        ...
        <div class="mt-6 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 dark:border-gray-700/50 overflow-hidden">
            <div class="p-4 lg:p-5">
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?php echo e(route('support')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-primary-600 dark:border-primary-500 rounded-lg shadow-sm text-sm font-medium text-primary-600 dark:text-primary-400 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm hover:bg-primary-50 dark:hover:bg-primary-900/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/verify.blade.php ENDPATH**/ ?>