...
<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
  <h1 class="text-dark fw-bolder my-1 fs-2">Welcome <?php echo e(Auth::user()->name); ?>, 👋🏼</h1>
...
<div class="card bg-transparent h-md-100" wire:poll>
    <div class="card-body p-0">
        <div class="px-9 pt-6 card-rounded w-100 bgi-no-repeat bgi-size-cover bgi-position-y-top bg-primary  h-250px ">
            ...
            <div class="fw-bold fs-5 text-center text-white pt-5 " style='font-size:65px'>
                 <h1>Available Balance</h1>
                <span class="fw-bolder fs-2hx d-block mt-n1">
                    <span id="main_balance" style='font-size:35px'>
                        <?php echo e($settings->currency); ?><?php echo e(number_format(Auth::user()->account_bal, 2, '.', ',')); ?>  <?php echo e($settings->s_currency); ?>                       </span>
                    
                </span>
            </div>
        </div>
                    <div class="shadow-xs card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1 bg-body" style="margin-top: -70px">
    ...
    <div class="col-md-4 mt-3  ">
      ...
      <div class="col-md-4 mt-3">
        <div class="card card-stats rounded mr-5 ">
          <div class="card-body">
            <div class="row mt-2">
              <div class="col">
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bank\resources\views/user/dashboard.blade.php ENDPATH**/ ?>