                        ...
                        <div class="card p-2 shadow ">
                         ...
                         <input class="form-control  " value="<?php echo e($user->address); ?>" type="text" name="address"
                             required>
                                                        ...
                                                        <div class="form-group col-md-12">
    <h6 class="text-<?php echo e($text); ?>">Initial Account Balance</h6>
    <input type="number" step="0.01" class="form-control text-<?php echo e($text); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/admin/createnewuser.blade.php ENDPATH**/ ?>