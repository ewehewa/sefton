                                    ...
                                    <div class="col-lg-12">
                                        <div class="fv-row mb-10">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <input type="password" class="form-control form-control-lg form-control-solidl" name="password" id="password" placeholder="Enter Password" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
...
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bank\resources\views/auth/adminlogin.blade.php ENDPATH**/ ?>