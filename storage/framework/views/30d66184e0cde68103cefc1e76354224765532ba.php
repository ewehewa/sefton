        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 bg-primary-600 text-white text-center">
                <a href="/" class="inline-block mb-4">
                    <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" alt="Logo" class="h-16 mx-auto filter brightness-0 invert">
                </a>
                ...
                <form method="POST" action="<?php echo e(route('adminlogin')); ?>" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('admin.forgetpassword')); ?>" class="text-sm text-primary-600 hover:text-primary-500 font-medium transition-colors">
                                Forgot password?
                            </a>
                        </div>
                        <div class="input-wrapper">
...
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/atlantictruist/public_html/resources/views/auth/adminlogin.blade.php ENDPATH**/ ?>