        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">
                    At <?php echo e($settings->site_name); ?>, we're dedicated to empowering individuals, families, and businesses to achieve their financial goals through innovative banking solutions, personalized service, and unwavering commitment to excellence.
                </p>
        ...
        <div class="space-y-8">
            <div class="flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="md:w-2/3">
                    ...
                    <p class="text-gray-600 dark:text-gray-300"><?php echo e($settings->site_name); ?> was founded with a simple mission: to provide honest, reliable banking services to our local community.</p>
                </div>
            </div>
...
<section class="py-16 bg-white dark:bg-gray-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1">
                <i class="fa-solid fa-user-plus mr-3"></i>
                Open an Account
            </a>
            <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center px-8 py-4 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-900 dark:text-white font-semibold rounded-2xl transition-all duration-300">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/home/about.blade.php ENDPATH**/ ?>