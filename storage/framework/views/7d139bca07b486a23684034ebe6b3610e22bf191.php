            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="mt-2 md:mt-0 md:ml-4">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-primary-100 text-gray-800">
                        Amount: <?php echo e($settings->currency); ?><?php echo e(number_format($amount)); ?> <?php echo e($settings->s_currency); ?>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <p>You are to make payment of <strong><?php echo e($settings->currency); ?><?php echo e(number_format($amount)); ?></strong> using your selected payment method. Screenshot and upload the proof of payment.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center mb-6">
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center w-full max-w-xs">
                        ...
                        <div class="mt-2 text-center w-full">
                            ...
                            <p class="text-xs text-gray-600"><?php echo e($settings->currency); ?><?php echo e($amount); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/globalch/public_html/resources/views/user/payment.blade.php ENDPATH**/ ?>