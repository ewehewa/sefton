...
} elseif ($_instance->childHasBeenRendered('XlK1tlX')) {
    $componentId = $_instance->getRenderedChildComponentId('XlK1tlX');
    $componentTag = $_instance->getRenderedChildComponentTagName('XlK1tlX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XlK1tlX');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('XlK1tlX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/public_html/demo3.remedyfinance.online/resources/views/user/payment.blade.php ENDPATH**/ ?>