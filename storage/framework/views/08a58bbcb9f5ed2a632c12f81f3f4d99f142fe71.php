...
} elseif ($_instance->childHasBeenRendered('puuHlAt')) {
    $componentId = $_instance->getRenderedChildComponentId('puuHlAt');
    $componentTag = $_instance->getRenderedChildComponentTagName('puuHlAt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('puuHlAt');
} else {
    $response = \Livewire\Livewire::mount('user.investment-plan', []);
    $html = $response->html();
    $_instance->logRenderedChild('puuHlAt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
