                                        ...
                                        <tbody id="userslisttbl">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    ...
                                                    <td> <?php if(!empty($user->profile_photo_path)): ?>
                                                        <img
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center rounded-circle fw-bold border border-secondary"
                                                             style="width: 40px; height: 40px; background-color: #0d6efd; color: white;">
                                                            <?php echo e($initials); ?>
...
<?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/livewire/admin/manage-users.blade.php ENDPATH**/ ?>