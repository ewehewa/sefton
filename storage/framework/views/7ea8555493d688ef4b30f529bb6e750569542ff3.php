...
} elseif ($_instance->childHasBeenRendered('Fk3tbYT')) {
    $componentId = $_instance->getRenderedChildComponentId('Fk3tbYT');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fk3tbYT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fk3tbYT');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('Fk3tbYT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('RYjlsoA')) {
    $componentId = $_instance->getRenderedChildComponentId('RYjlsoA');
    $componentTag = $_instance->getRenderedChildComponentTagName('RYjlsoA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RYjlsoA');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('RYjlsoA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fxproglobaltradi/public_html/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>