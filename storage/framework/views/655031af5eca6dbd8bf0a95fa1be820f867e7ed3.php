...
<div class="sidebar sidebar-style-2" data-background-color="<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
 ...
 <li
                    ...
                    <li class="nav-item <?php echo e(request()->routeIs('admin.grants.*') ? 'active' : ''); ?>">
                        <a data-toggle="collapse" href="#grantApplications">
                            <i class="fas fa-hand-holding-usd"></i>
                            <p>Grant Applications</p>
                            <span class="caret"></span>
                        </a>
                        <div class="collapse <?php echo e(request()->routeIs('admin.grants.*') ? 'show' : ''); ?>" id="grantApplications">
                            <ul class="nav nav-collapse">
                                <li class="<?php echo e(request()->routeIs('admin.grants.index') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.grants.index')); ?>">
                                        <span class="sub-item">All Applications</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(request()->routeIs('admin.grants.pending') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.grants.pending')); ?>">
                                        <span class="sub-item">Processing</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(request()->routeIs('admin.grants.approved') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.grants.approved')); ?>">
                                        <span class="sub-item">Approved</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(request()->routeIs('admin.grants.rejected') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.grants.rejected')); ?>">
                                        <span class="sub-item">Rejected</span>
                                    </a>
                                </li>
                                <li class="<?php echo e(request()->routeIs('admin.grants.disbursed') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.grants.disbursed')); ?>">
...
<li class="nav-item <?php echo e(request()->routeIs('transaction.history') ? 'active' : ''); ?> <?php echo e(request()->routeIs('transaction.form') ? 'active' : ''); ?>">
    ...
    <div class="collapse" id="transactionHistory">
        <ul class="nav nav-collapse">
            ...
            <li>
                <a href="<?php echo e(route('transaction.form')); ?>">
                ...
                <?php if(Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin'): ?>
                    ...
                    <li
                        class="nav-item <?php echo e(request()->routeIs('admin.cards') ? 'active' : ''); ?> <?php echo e(request()->routeIs('admin.card.view') ? 'active' : ''); ?>">
                        ...
                        <div class="collapse" id="vcards">
                            <ul class="nav nav-collapse">
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.cards.pending')); ?>">
                                        <span class="sub-item">Pending Applications</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('admin.cards.settings')); ?>">
                    ...
                    <li class="nav-item <?php echo e(request()->routeIs('admin.irs-refunds.*') ? 'active' : ''); ?>">
                        ...
                        <div class="collapse" id="irsrefunds">
                            <ul class="nav nav-collapse">
                                <li>
                                    <a href="<?php echo e(route('admin.irs-refunds.index')); ?>">
                                        <span class="sub-item">All Refunds</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('admin.irs-refunds.pending')); ?>">
                                        <span class="sub-item">Pending Refunds</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('admin.irs-refunds.settings')); ?>">
                    ...
                    <li
                        ...
                        <div class="collapse" id="settings">
                            <ul class="nav nav-collapse">
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.appearance')); ?>">
...
<!-- End Sidebar -->
<?php /**PATH /home/nexatrus/public_html/resources/views/admin/sidebar.blade.php ENDPATH**/ ?>