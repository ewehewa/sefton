                        ...
                        <div class="deposits-item is-active" deposit="Starting">
                          <div class="deposits-item__content">
                            <div class="deposits-item__count"style="margin: 0;"> 
                              <div class="deposits-item__count-number"><?php echo e($plan->increment_amount); ?>                              </div>
                            ...
                            <div class="deposits-item__item deposits-item__item--earn">
                              <p class="deposits-item__item-title"><?php echo e($plan->increment_interval); ?></p>
                            </div>
                            <div class="deposits-item__item"> 
                              <p class="deposits-item__item-title">Deposit: 
                              </p>
                              <p class="deposits-item__item-value"><?php echo e($settings->currency); ?><?php echo e($plan->min_price); ?>  - <?php echo e($settings->currency); ?><?php echo e($plan->max_price); ?>

                              </p>
                            </div>
                            <div class="deposits-item__item deposits-item__item--earn">
                              <p class="deposits-item__item-title"><?php echo e($plan->expiration); ?></p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="company__row"> 
                      ...
                      <div class="certificate"> 
                       <div class="total-invested"> 
                        ...
                        <div class="participants">
                          ...
                          <p class="participants__count"><?php echo e($total_users+89650); ?>                         </p>
                        </div>
                        <ul class="totals"> 
                          <li> 
                            <p class="totals__title">Total Invested                            </p>
                            <p class="totals__value"><?php echo e($total_deposits+338400989); ?> <sub>USD</sub>
                            </p>
                          </li>
                          <li> 
                            <p class="totals__title">Total Paid                            </p>
                            <p class="totals__value"><?php echo e($total_withdrawals+101689885); ?><sub>USD</sub>
                            </p>
                          </li>
                    ...
                    <div class="company__col"> 
                      ...
                      <div class="typography"> 
                        ...
                        <p><?php echo e($settings->site_name); ?> is registered and has official permission for investment and trading activities. The services of our company are available to every investor from anywhere in the world.</p>
                      </div>
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/demo.remedyfinance.online/resources/views/home/index.blade.php ENDPATH**/ ?>