    ...
    <div class="main-panel">
        <div class="content ">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h1 class="title1  d-inline"> <?php echo e($user->name); ?> Loans</h1>
                    <div class="d-inline">
                                        ...
                                        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="badge badge-warning"><?php echo e($plan->active); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($plan->active == 'Processed'): ?>
                                                        <a href="<?php echo e(route('markas', ['id' => $plan->id, 'status' => 'Pending'])); ?>"
                                                            class="m-1 btn btn-danger btn-sm">Mark as Pending</a>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('markas', ['id' => $plan->id, 'status' => 'Processed'])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/admin/Users/user_plans.blade.php ENDPATH**/ ?>