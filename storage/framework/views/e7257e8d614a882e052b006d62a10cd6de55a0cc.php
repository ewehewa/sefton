    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8">
                ...
                <form action="<?php echo e(route('homesendcontact')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-300"><?php echo e($settings->contact_email); ?></p>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/home/contact.blade.php ENDPATH**/ ?>