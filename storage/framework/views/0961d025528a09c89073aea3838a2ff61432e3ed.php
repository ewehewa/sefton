            ...
            <div class="mb-4 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800/50 dark:to-gray-700/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <span class="text-gray-500 text-lg font-bold" x-text="withdrawMethod === 'Cryptocurrency' ? '' : '<?php echo e(Auth::user()->s_curr); ?>'"></span>
                    </div>
                    <input 
                        type="number" 
                        name="amount" 
                        ...
                        :max="withdrawMethod === 'Cryptocurrency' ? <?php echo e(Auth::user()->btc_balance ?? 0); ?> : <?php echo e(Auth::user()->account_bal); ?>"
...
</div><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/partials/international/transfer-form.blade.php ENDPATH**/ ?>