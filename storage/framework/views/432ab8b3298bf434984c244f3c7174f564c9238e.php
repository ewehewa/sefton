...
<?php endif; ?>
    ...
    <div class="w-lg-600px w-100 p-10 p-lg-15 mx-auto">
        ...
        <a href="<?php echo e(route('register')); ?>" class="btn btn-danger btn-lg btn-block fw-bolder my-2">
            <i class="fal fa-arrow-left"></i> Create Account
        </a>   
                  </div>
      </form>
    </div>
...
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedycodes/public_html/fin.remedycodes.online/resources/views/auth/register.blade.php ENDPATH**/ ?>