    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content card-body">
            ...
            <div class="modal-body">
                <form  action = "<?php echo e(route('updateuserpass')); ?>"  method="post" class="mb-10">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/user/editpass.blade.php ENDPATH**/ ?>