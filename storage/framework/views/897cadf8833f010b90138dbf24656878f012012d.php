         ...
         <div class="modal-content">
             ...
             <div class="modal-body ">
                 <form method="post" action="<?php echo e(route('topup')); ?>">
                    ...
                    <div class="form-group">
                        <h5 class="">Send Email and SMS User</h5>
                        <select class="form-control" name="sendmail" type='text' >
...
<div id="userActionsignal" class="modal fade" role="dialog">
 ...
 <!-- /Delete user Modal -->
<?php /**PATH C:\xampp\htdocs\remedybank\resources\views/admin/Users/users_actions.blade.php ENDPATH**/ ?>