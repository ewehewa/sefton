...
<?php endif; ?>
        ...
        <div class="hidden lg:flex items-center justify-between mb-4">
            <div class="flex items-center space-x-2">
                <a href="<?php echo e(route('grant.index')); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-600 transition-colors">
                ...
                <form action="<?php echo e(route('grant.storeCompany')); ?>" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="mailing_address" name="mailing_address" rows="3" required
                                  class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full px-2 py-2.5 border shadow-sm text-sm border-gray-300 dark:border-gray-600 rounded-lg bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"><?php echo e(old('mailing_address')); ?></textarea>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="mission_statement" name="mission_statement" rows="3" required
                                  class="mt-1 focus:ring-primary-500 focus:border-primary-500 px-2 py-2.5 border block w-full shadow-sm text-sm border-gray-300 dark:border-gray-600 rounded-lg bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"><?php echo e(old('mission_statement', $application ? $application->mission_statement : '')); ?></textarea>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="project_description" name="project_description" rows="4" required
                                  class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full px-2 py-2.5 border shadow-sm text-sm border-gray-300 dark:border-gray-600 rounded-lg bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"><?php echo e(old('project_description', $application ? $application->project_description : '')); ?></textarea>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="expected_outcomes" name="expected_outcomes" rows="3" required
                                  class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full px-2 py-2.5 border shadow-sm text-sm border-gray-300 dark:border-gray-600 rounded-lg bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"><?php echo e(old('expected_outcomes', $application ? $application->expected_outcomes : '')); ?></textarea>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/grant/company.blade.php ENDPATH**/ ?>