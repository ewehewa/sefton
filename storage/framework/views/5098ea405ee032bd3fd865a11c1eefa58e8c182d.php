...
<div class="main-panel bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('tacnts')); ?>" class="nav-link">Provisioned Accounts</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="table-responsive" data-example-id="hoverable-table">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $subscriptions;
                                                    ...
                                                    <td>
                                                        <?php if ($sub->status == 'Pending') : ?>
                                                            <form action="" method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <button type="submit" class="mb-2 btn btn-primary btn-sm">Process</button>
                                                            </form>
    ...
    <?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/admin/msubtrade.blade.php ENDPATH**/ ?>