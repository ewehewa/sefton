...
} elseif ($_instance->childHasBeenRendered('7AuyH4X')) {
    $componentId = $_instance->getRenderedChildComponentId('7AuyH4X');
    $componentTag = $_instance->getRenderedChildComponentTagName('7AuyH4X');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7AuyH4X');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('7AuyH4X', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('7VY1evO')) {
    $componentId = $_instance->getRenderedChildComponentId('7VY1evO');
    $componentTag = $_instance->getRenderedChildComponentTagName('7VY1evO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7VY1evO');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('7VY1evO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/public_html/account/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>