...
} elseif ($_instance->childHasBeenRendered('qfrbLBL')) {
    $componentId = $_instance->getRenderedChildComponentId('qfrbLBL');
    $componentTag = $_instance->getRenderedChildComponentTagName('qfrbLBL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qfrbLBL');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('qfrbLBL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
                                                ...
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <?php if((!empty($payment_mode->barcode) or $payment_mode->barcode != null) and
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control readonly"
                                                            value="bc1qep6feen644je9lryt23cwe4mp5ee99ldlrg0sg" id="reflink"
                                                            readonly>
                                    ...
                                    <?php if($settings->deposit_option == 'auto' and $payment_mode->name == 'Bank Transfer' or
                                    ...
                                    <?php endif; ?>
                                    <?php if($settings->deposit_option == 'manual' and
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fxproglobaltradi/public_html/resources/views/user/payment.blade.php ENDPATH**/ ?>