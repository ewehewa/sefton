...
<span style="text-transform: uppercase;"><?php echo e($settings->site_name); ?> Policy</span>
<h4>Learn more about how <?php echo e($settings->site_name); ?> protects and uses your personal information.</h4>
</div>
</div>
</div>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12">
			...
			<p>We are <?php echo e($settings->site_name); ?> Private Bank, the data controller. You can 
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/home/terms.blade.php ENDPATH**/ ?>