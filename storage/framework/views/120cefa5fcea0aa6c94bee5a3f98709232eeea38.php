...
<?php $__env->startSection('title', 'Saved Beneficiaries'); ?>
    ...
    return {
        ...
        transferToBeneficiary(beneficiary) {
            if (beneficiary.type === 'local') {
                window.location.href = `<?php echo e(route('localtransfer')); ?>?beneficiary=${beneficiary.id}`;
                ...
                window.location.href = `<?php echo e(route('internationaltransfer')); ?>?beneficiary=${beneficiary.id}${method}`;
            }
        },
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/beneficiaries/index.blade.php ENDPATH**/ ?>