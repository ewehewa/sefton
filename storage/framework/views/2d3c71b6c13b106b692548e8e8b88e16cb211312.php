...
} elseif ($_instance->childHasBeenRendered('8lezjW8')) {
    $componentId = $_instance->getRenderedChildComponentId('8lezjW8');
    $componentTag = $_instance->getRenderedChildComponentTagName('8lezjW8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8lezjW8');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('8lezjW8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fxproglobaltradi/public_html/resources/views/user/withdraw.blade.php ENDPATH**/ ?>