                                ...
                                <div
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-white p-2">It should only take a couple of minute to create your
                                            account.</p>
                                        <img src="<?php echo e(asset('dash2/img/account.webp')); ?>" alt="" class="w-75">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="text-center">
                                    ...
                                    <form method="POST" action="<?php echo e(route('register')); ?>" class="mt-4 login-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <button class="btn btn-success btn-block pad"
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fxproglobaltradi/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>