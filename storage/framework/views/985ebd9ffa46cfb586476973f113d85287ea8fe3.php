...
<img class="logo-light" src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>" alt="<?php echo e($settings->site_name); ?>  " width="200" height="260">
<img class="logo-dark" src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>" alt="<?php echo e($settings->site_name); ?>" width="200" height="260">
</a>
...
<footer class="footer-wrap">
  ...
  <img src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>" alt="Image">
  </a>
  <p class="comp-desc">
  ...
  <h6>Email</h6>
  <a href="#"><?php echo e($settings->site_name); ?></a>
  </li>
  <li>
  <i class="ri-phone-fill"></i>
  <h6>Phone</h6>
  <a href="<?php echo e($settings->whatsapp); ?>">VIP ONLY</a>
  </li>
  </ul>
  </div>
  </div>
  ...
  <div class="row">
  <div class="col-md-12">
  <p class="copyright-text"><i class="ri-copyright-line"></i> <span></span>Copyright. All Rights Reserved By <a href="login" target="_blank"><?php echo e($settings->site_name); ?></a></p>
  </div>
  </div>
  </div>
  </footer>
...
<!-- Floating Google Translate Button -->
<div id="translate-toggle" onclick="toggleTranslateWidget()">
...
<script>
  function toggleTranslateWidget() {
    const widget = document.getElementById('google_translate_element_wrapper');
...
<script type="text/javascript">
var _smartsupp = _smartsupp || {};
_smartsupp.key = '9f5d4d873126d6daa7e2e733a2436f99d89e4044';
window.smartsupp||(function(d) {
  var s,c,o=smartsupp=function(){ o._.push(arguments)};o._=[];
  s=d.getElementsByTagName('script')[0];c=d.createElement('script');
  c.type='text/javascript';c.charset='utf-8';c.async=true;
...
<?php /**PATH /home/libertytruist/public_html/resources/views/layouts/base.blade.php ENDPATH**/ ?>