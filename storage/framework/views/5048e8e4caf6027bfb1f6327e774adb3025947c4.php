...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 w-full">
                    ...
                    <div class="mt-4 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        Suspended on: <?php echo e(\Carbon\Carbon::parse($bannedAt)->format('M j, Y \a\t g:i A')); ?>
                    ...
                    <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        Expires on: <?php echo e(\Carbon\Carbon::parse($banExpiresAt)->format('M j, Y \a\t g:i A')); ?>
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
            ...
            <div class="space-y-2 text-sm text-blue-700 dark:text-blue-300">
                ...
                <div class="flex items-center">
                    ...
                    <span>Phone: <?php echo e($settings->contact_phone ?? '+1-800-BANKING'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="text-center text-sm text-gray-500 dark:text-gray-400 mt-8">
            <p>© <?php echo e(date('Y')); ?> <?php echo e($settings->site_name ?? 'Your Bank'); ?>. All rights reserved.</p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/user/banned.blade.php ENDPATH**/ ?>