        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-8 z-10">
            ...
            <div class="mb-6 relative">
                ...
                <div class="relative bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                    <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" alt="Logo" class="h-12 filter brightness-0 invert">
                </div>
            </div>
            ...
            <h2 class="text-lg font-semibold mb-6 text-center text-white/90">
                <?php echo e($settings->site_name); ?> Management
            </h2>
        ...
        <div class="w-full max-w-sm">
            ...
            <div class="lg:hidden text-center mb-6">
                <div class="relative inline-block mb-3 mt-10">
                    ...
                    <div class="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-3 border border-gray-200/50 dark:border-gray-700/50">
                        <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" alt="Logo" class="h-10 mx-auto">
                    </div>
                </div>
            ...
            <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="px-6 pb-6 pt-4">
                    <form method="POST" action="<?php echo e(route('adminlogin')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-1">
                            <div class="flex items-center justify-between">
                               ...
                               <!-- <a href="<?php echo e(route('admin.forgetpassword')); ?>" class="text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300 transition-colors">
                                    Forgot Password?
                                </a> -->
                            </div>
                            <div class="input-wrapper group">
            ...
            <div class="mt-6 text-center space-y-3">
                <div class="flex items-center justify-center space-x-4 text-xs">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium flex items-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/auth/adminlogin.blade.php ENDPATH**/ ?>