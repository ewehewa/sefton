...
} elseif ($_instance->childHasBeenRendered('pzJHKzu')) {
    $componentId = $_instance->getRenderedChildComponentId('pzJHKzu');
    $componentTag = $_instance->getRenderedChildComponentTagName('pzJHKzu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pzJHKzu');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('pzJHKzu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('JJccbzm')) {
    $componentId = $_instance->getRenderedChildComponentId('JJccbzm');
    $componentTag = $_instance->getRenderedChildComponentTagName('JJccbzm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JJccbzm');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('JJccbzm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/captoylz/public_html/auth/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>