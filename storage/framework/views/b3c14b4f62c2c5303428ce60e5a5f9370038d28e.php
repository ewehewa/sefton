...
<section id="hero">
  ...
  <div id="section1" class="container default-wd mobile-padding-top1">
      <div class="title">
      <h2><p class="hidden-xs" style="padding-bottom:5px;font-size:28px; text-align:center;font-weight:600;"><?php echo e($settings->site_name); ?>  Trading Bot</p></h2>
      </div>
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-lg-9">
          ...
          <ul class="faq-list">
            ...
            <li>
              <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">What is <?php echo e($settings->site_name); ?>  Trading Bot? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                <p>
                  <?php echo e($settings->site_name); ?>  Trading Bot are free to use software that users can use to automate their crypto trading.
                </p>
              </div>
            </li>
            ...
            <li>
              ...
              <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                <p>
                  The Spot trading bot is a great <?php echo e($settings->site_name); ?>  Trading strategy, it allows users to buy low and sell high in specific price changes. 
                </p>
              </div>
            </li>

            <li>
              <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">Can you make money with <?php echo e($settings->site_name); ?>  Trading Bot? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              <div id="faq3" class="collapse" data-bs-parent=".faq-list">
                <p>
                  Countless users have earned passive stable income using <?php echo e($settings->site_name); ?>  Trading Bot at no cost. That said, all trading involves risk. Every investor and trader should trade cryptocurrency responsibly and avoid emotional decisions.
                </p>
              </div>
            </li>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\remedy\resources\views/home/tradebots.blade.php ENDPATH**/ ?>