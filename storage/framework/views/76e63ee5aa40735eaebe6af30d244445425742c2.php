        ...
        <div>
            ...
            <div class="mt-4">
                ...
                <a href="#" class="shadow btn btn-sm btn-white btn-icon rounded-pill hover-translate-y-n3">
                    ...
                    <span
                        class="btn-inner--text"><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format(Auth::user()->account_bal, 2, '.', ',')); ?></span>
                </a>
            </div>
        </div>
        <!-- User info -->
...
<?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/user/sidebar.blade.php ENDPATH**/ ?>