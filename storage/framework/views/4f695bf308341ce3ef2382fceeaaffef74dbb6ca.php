                        ...
                        <div class="col-lg-4">
                            <div class="pricing-table purple border p-4 card  shadow">
                                ...
                                <div class="pricing-features">
                                    ...
                                    <div class="feature ">Duration:<span class=""><?php echo e($plan->expiration); ?></span>
                                    </div>
                                </div> <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/admin/Plans/plans.blade.php ENDPATH**/ ?>