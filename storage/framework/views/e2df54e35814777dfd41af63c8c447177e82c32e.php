...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="daily_limit" id="daily_limit" min="<?php echo e($minLimit); ?>" max="<?php echo e($maxLimit); ?>" value="<?php echo e(old('daily_limit', $minLimit)); ?>" class="focus:ring-primary-500 px-2 py-3 border focus:border-primary-500 block w-full pb-2 pt-2 pl-7 pr-12 sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['daily_limit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 sm:text-sm"><?php echo e(Auth::user()->curr); ?></span>
                            </div>
                        </div>
                        <p class="mt-1 text-sm text-gray-500">Limits: <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($minLimit, 2)); ?> - <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($maxLimit, 2)); ?></p>
            ...
            <section class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="card_holder_name" id="card_holder_name" value="<?php echo e(old('card_holder_name', auth()->user()->name)); ?>" class="mt-1 focus:ring-primary-500 px-2 py-3 border pl-2 pb-2 pt-2 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['card_holder_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="billing_address" id="billing_address" rows="3" class="mt-1 pl-2 pt-2 px-2 py-3 border focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['billing_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <section class="border-t border-gray-200 pt-6">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-gray-700">
                                ...
                                <ul class="list-disc pl-5 mt-1 space-y-1">
                                    <li>Standard: <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($issuanceFees['standard'], 2)); ?></li>
                                    <li>Gold: <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($issuanceFees['gold'], 2)); ?></li>
                                    <li>Platinum: <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($issuanceFees['platinum'], 2)); ?></li>
                                    <li>Black: <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($issuanceFees['black'], 2)); ?></li>
                                </ul>
                ...
                <div class="flex items-start mb-4">
                    <div class="flex items-center h-5">
                        <input id="terms" name="terms_accepted" type="checkbox" class="focus:ring-primary-500 h-4 w-4 px-2 py-3 bordertext-primary-600 border-gray-300 rounded" required>
                    </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nexatrus/public_html/resources/views/user/cards/apply.blade.php ENDPATH**/ ?>