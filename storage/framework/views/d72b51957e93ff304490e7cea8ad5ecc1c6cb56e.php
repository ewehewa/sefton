    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-3 lg:p-8 bg-gray-50/50 dark:bg-gray-900/50 backdrop-blur-sm">
        <div class="w-full max-w-sm">
            ...
            <div class="lg:hidden text-center mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Sign in to <?php echo e($settings->site_name); ?></p>
            </div>
            ...
            <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="px-6 pt-6 pb-4 border-b border-gray-100/50 dark:border-gray-700/50">
                    <div class="hidden lg:block">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Access your <?php echo e($settings->site_name); ?> account</p>
                    </div>
                    <div class="lg:hidden">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                        ...
                        <div class="space-y-1">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300 transition-colors">
                                    Forgot Password?
                                </a>
                            </div>
                            <div class="input-wrapper group">
                        ...
                        <div class="relative py-3">
                            ...
                            <div class="relative flex justify-center text-xs">
                                <span class="px-3 bg-white/90 dark:bg-gray-800/90 text-gray-500 dark:text-gray-400 font-medium">
                                    New to <?php echo e($settings->site_name); ?>?
                                </span>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/auth/login.blade.php ENDPATH**/ ?>