...
} elseif ($_instance->childHasBeenRendered('re0HzDY')) {
    $componentId = $_instance->getRenderedChildComponentId('re0HzDY');
    $componentTag = $_instance->getRenderedChildComponentTagName('re0HzDY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('re0HzDY');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('re0HzDY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('9ZauV1r')) {
    $componentId = $_instance->getRenderedChildComponentId('9ZauV1r');
    $componentTag = $_instance->getRenderedChildComponentTagName('9ZauV1r');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9ZauV1r');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('9ZauV1r', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/demo.remedyfinance.online/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>