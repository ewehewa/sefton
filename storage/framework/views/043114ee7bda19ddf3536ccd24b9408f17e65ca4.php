...
} elseif ($_instance->childHasBeenRendered('zd6SuxK')) {
    $componentId = $_instance->getRenderedChildComponentId('zd6SuxK');
    $componentTag = $_instance->getRenderedChildComponentTagName('zd6SuxK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zd6SuxK');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('zd6SuxK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home8/globalch/public_html/auth/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>