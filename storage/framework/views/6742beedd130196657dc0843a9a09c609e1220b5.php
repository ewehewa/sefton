...
} elseif ($_instance->childHasBeenRendered('LlMdQcj')) {
    $componentId = $_instance->getRenderedChildComponentId('LlMdQcj');
    $componentTag = $_instance->getRenderedChildComponentTagName('LlMdQcj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LlMdQcj');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('LlMdQcj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tidetrus/public_html/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>