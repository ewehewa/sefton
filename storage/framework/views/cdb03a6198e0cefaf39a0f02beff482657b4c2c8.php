...
<?php endif; ?>
            ...
            <form class="form w-100" action="<?php echo e(route('codecomfirm')); ?>" method="post">
                ...
                <div class="fv-row mb-10">
                    ...
                    <input class="form-control form-control-lg form-control-solid"   name="otp" type="text" placeholder="Enter OTP code" >
                                    </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/resources/views/user/otp.blade.php ENDPATH**/ ?>