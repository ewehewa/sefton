...
<head>
    ...
    <script>
        ...
        document.documentElement.style.setProperty('--secondary-color-light', '<?php echo e(isset($appearanceSettings) ? $appearanceSettings->secondary_color_light : "#5eead4"); ?>');
...
<body class="font-sans bg-gray-50 text-gray-900 flex min-h-screen">
    ...
    <script>
        // Add this to a JavaScript file loaded by your app
let deferredPrompt;
const installButton = document.getElementById('install-button'); // Create this button in your UI
...
</html><?php /**PATH /home/luxehave/trade.luxehavenhotel.com/resources/views/layouts/guest2.blade.php ENDPATH**/ ?>