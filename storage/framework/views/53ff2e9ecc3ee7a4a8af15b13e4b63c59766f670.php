...
} elseif ($_instance->childHasBeenRendered('6ZPn6gO')) {
    $componentId = $_instance->getRenderedChildComponentId('6ZPn6gO');
    $componentTag = $_instance->getRenderedChildComponentTagName('6ZPn6gO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6ZPn6gO');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('6ZPn6gO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH /home/captoylz/public_html/auth/resources/views/admin/subscription/master/statistics.blade.php ENDPATH**/ ?>