...
} elseif ($_instance->childHasBeenRendered('kXMewcN')) {
    $componentId = $_instance->getRenderedChildComponentId('kXMewcN');
    $componentTag = $_instance->getRenderedChildComponentTagName('kXMewcN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kXMewcN');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('kXMewcN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('A0Rjosv')) {
    $componentId = $_instance->getRenderedChildComponentId('A0Rjosv');
    $componentTag = $_instance->getRenderedChildComponentTagName('A0Rjosv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('A0Rjosv');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('A0Rjosv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/public_html/demo3.remedyfinance.online/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>