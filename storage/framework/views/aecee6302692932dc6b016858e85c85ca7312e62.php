...
} elseif ($_instance->childHasBeenRendered('1ltrCcF')) {
    $componentId = $_instance->getRenderedChildComponentId('1ltrCcF');
    $componentTag = $_instance->getRenderedChildComponentTagName('1ltrCcF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1ltrCcF');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('1ltrCcF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control readonly"
                                                            value="<?php echo e($payment_mode->wallet); ?>" id="reflink"
                                                            readonly>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/public_html/account/resources/views/user/payment.blade.php ENDPATH**/ ?>