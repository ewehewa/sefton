...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
      ...
      <td><?php echo e($settings->currency); ?><?php echo e($loan->amount); ?> <?php echo e($settings->s_currency); ?></td>

      <td><?php echo e($loan->purpose); ?> </td>
      <td><?php echo e($loan->duration); ?></td>
      <?php if($loan->active !='active'): ?>
          <td><span class="badge badge-pill badge-warning badge-sm"><?php echo e($loan->active); ?></span></td>
          <?php else: ?>
          <td><span class="badge badge-pill badge-success badge-sm"><?php echo e($loan->active); ?></span></td>
          <?php endif; ?>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/resources/views/user/loans.blade.php ENDPATH**/ ?>