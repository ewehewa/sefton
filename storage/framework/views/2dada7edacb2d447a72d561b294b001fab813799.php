                  ...
                  <div class="input-group mb-3">
                    ...
                    <input class="form-control form-control-lg form-control-solid" type="tel" name="phone" autocomplete="phone" value="<?php echo e(Auth::user()->phone); ?>" required placeholder="123456789" readonly/>
                                  ...
                                  <div class="fv-row mb-6">
                                      ...
                                      <textarea class="form-control form-control-lg form-control-solid preserveLines" rows="5" type="text" name="<?php echo e(Auth::user()->address); ?>" required placeholder="Address"></textarea>
                                  </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/resources/views/user/profile.blade.php ENDPATH**/ ?>