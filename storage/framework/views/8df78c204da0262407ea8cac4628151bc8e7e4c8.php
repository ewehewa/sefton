...
} elseif ($_instance->childHasBeenRendered('NflRM3P')) {
    $componentId = $_instance->getRenderedChildComponentId('NflRM3P');
    $componentTag = $_instance->getRenderedChildComponentTagName('NflRM3P');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NflRM3P');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('NflRM3P', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH /home/prostableassets/public_html/fund/resources/views/admin/subscription/master/statistics.blade.php ENDPATH**/ ?>