...
<div class="main-header">
    ...
    <nav class="navbar navbar-header navbar-expand-lg" data-background-color="<?php echo e($bgmenu); ?>">
        ...
        <a href="<?php echo e(url('/admin/dashboard/about')); ?>" class='btn text-white'> About script</a>
    </nav>
    <!-- End Navbar -->
...
<?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/admin/topmenu.blade.php ENDPATH**/ ?>