        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <?php if(Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin'): ?>
                    ...
                    <li
                        class="nav-item <?php echo e(request()->routeIs('msubtrade') ? 'active' : ''); ?> <?php echo e(request()->routeIs('tsettings') ? 'active' : ''); ?> <?php echo e(request()->routeIs('tacnts') ? 'active' : ''); ?>">
                ...
                <?php endif; ?>
                    ...
                    <li class="nav-item <?php echo e(request()->routeIs('aboutonlinetrade') ? 'active' : ''); ?>">
                        <a href="https://t.me/+VRumJJSKKGdjM2I0">
                            ...
                            <p>Contact remedy techy for help</p>
                        </a>
                    </li>
...
<!-- End Sidebar -->
<?php /**PATH /home/prostableassets/public_html/fund/resources/views/admin/sidebar.blade.php ENDPATH**/ ?>