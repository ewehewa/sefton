...
<?php endif; ?>
    ...
    <div class="w-lg-600px w-100 p-10 p-lg-15 mx-auto">
        ...
        <a href="<?php echo e(route('login')); ?>" class="btn btn-light btn-lg btn-block fw-bolder my-2">
...
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>