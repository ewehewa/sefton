...
} elseif ($_instance->childHasBeenRendered('dWvysDh')) {
    $componentId = $_instance->getRenderedChildComponentId('dWvysDh');
    $componentTag = $_instance->getRenderedChildComponentTagName('dWvysDh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dWvysDh');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('dWvysDh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prostableassets/public_html/fund/resources/views/user/payment.blade.php ENDPATH**/ ?>