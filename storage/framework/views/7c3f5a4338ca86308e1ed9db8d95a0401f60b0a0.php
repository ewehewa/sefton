...
<section class="hero-wrap style2">
    ...
    <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400"><?php echo e($settings->site_name); ?> transformed the digital banking industry using data and technology more than ten years ago. We are now one of the largest digital banking providers, dedicated to innovating, simplifying, and humanizing banking.</p>
    ...
    <p><?php echo e($settings->site_name); ?> transformed the credit card business using data and technology more than ten years ago. We are now one of the largest digital banking providers, dedicated to innovating, simplifying, and humanizing banking.</p>
    </div>
    <div class="feature-item-wrap">
    <div class="feature-item">
    <div class="feature-icon">
    ...
    <p class="client-quote">I opened a checking and savings account at <?php echo e($settings->site_name); ?> on McHenry in Modesto, California. The teller who helped me was a pleasure to work with. She was very knowledgeable and through setting up my accounts. She made my day a pleasant day. Thank you for the terrific customer service.</p>
    </div>
    ...
    <p class="client-quote">I've been with <?php echo e($settings->site_name); ?> for four years. I went through a loan modification with them, as well as a six-month forbearance. I also have a credit card with them, which they have cancelled after every late payment, as well as a cash account with withdrawal fees. They are always there to help me.</p>
    </div>
    <div class="testimonial-card style3" style="min-height: 300px;">
    <div class="client-info-area">
    <div class="client-info-wrap">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home8/globalch/public_html/auth/resources/views/home/index.blade.php ENDPATH**/ ?>