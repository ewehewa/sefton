...
} elseif ($_instance->childHasBeenRendered('mQqDBZQ')) {
    $componentId = $_instance->getRenderedChildComponentId('mQqDBZQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('mQqDBZQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mQqDBZQ');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('mQqDBZQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
