                        ...
                        <div class="mb-3">
                            <div class="mb-3 form-group">
                                ...
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->bankname); ?>" readonly>
                            </div>
                            <div class="mb-3 form-group">
                                <h5 class="">Account Name</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->accountname); ?>" readonly>
                            </div>
                            <div class="mb-3 form-group">
                                <h5 class="">Account Number</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->accountnumber); ?>" readonly>
                            </div>
                            ...
                            <div class="mb-3 form-group">
                                <h5 class="">Amount</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($settings->currency); ?><?php echo e($withdrawal->amount); ?>" readonly>
                            </div>
                            <div class="mb-3 form-group">
                                <h5 class="">Acount Type</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->Accounttype); ?>" readonly>
                            </div>

                            <div class="mb-3 form-group">
                                <h5 class="">Transfer Type</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->payment_mode); ?>" readonly>
                            </div>

                            <div class="mb-3 form-group">
                                <h5 class="">Description</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->Description); ?>" readonly>
                            </div>

                            <div class="mb-3 form-group">
                                <h5 class="">Bank Addresss</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->bankaddress); ?>" readonly>
                            </div>

                            <div class="mb-3 form-group">
                                <h5 class="">Country</h5>
                                <input type="text" class="form-control readonly  "
                                    value="<?php echo e($withdrawal->country); ?>" readonly>
                            </div>
                        </div>
                            ...
                            <div class="mt-1">
                                <form action="<?php echo e(route('pwithdrawal')); ?>" method="POST">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <h6 class="">Date</h6>
                                            <input name="date"  type='date' id="action" class="  mb-2 form-control">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/resources/views/admin/Withdrawals/pwithrdawal.blade.php ENDPATH**/ ?>