                ...
                <?php else: ?>
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                        <div class="flex items-center mb-4">
                            <div class="h-12 w-12 rounded-full bg-primary-100 flex items-center justify-center mr-4">
                                <i data-lucide="user-check" class="h-6 w-6 text-gray-600"></i>
                            </div>
                            <div>
                                <h2 class="text-xl font-semibold text-gray-900">Welcome to <?php echo e($settings->site_name); ?></h2>
                        ...
                        <div class="prose prose-sm max-w-none text-gray-600 mb-4">
                            <p class="mb-2"><strong>Dear <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->lastname); ?> <?php echo e(Auth::user()->middlename); ?>,</strong></p>
                            ...
                            <p>Our excellent customer support team is available 24/7 to help you with any questions. You can contact them at: <a href="mailto:<?php echo e($settings->contact_email); ?>" class="text-primary-600 hover:text-primary-700"><?php echo e($settings->contact_email); ?></a>.</p>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-6">
                        ...
                        <div class="flex flex-wrap gap-4 justify-center sm:justify-start">
                            <a href="<?php echo e(route('kycform')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                                <i data-lucide="check-circle" class="h-4 w-4 mr-2"></i>
                                I Accept & Proceed to Verification
                            </a>
                            
                            <a href="<?php echo e(route('logout')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
            ...
            <div class="flex flex-col md:flex-row gap-6 items-center">
                <div class="flex-shrink-0">
                    <div class="h-16 w-16 bg-primary-50 rounded-full flex items-center justify-center">
                        <i data-lucide="life-buoy" class="h-8 w-8 text-gray-600"></i>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/atlantictruist/public_html/resources/views/user/verify.blade.php ENDPATH**/ ?>