...
<style>
  ...
  <main id="main">
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6">
            <h2><?php echo e($settings->site_name); ?> </h2>
            ...
            <p><?php echo e($settings->site_name); ?>  Trading Limited is committed to leading this wave of change; by connecting with, educating and empowering younger generations to reimagine, redefine and reengineer their lives, and the world.</p>
        ...
        <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <h4 style="color:red;">We believe in learning to teach, and teaching to learn. <?php echo e($settings->site_name); ?>  Media is our channel to educate; to connect with the world, to maintain the integrity of our perspective, and to share our intellectual truth.</h4>
                <p></p>
              </div>
            </div>
          </div>
  ...
  <section id="herod">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <p class="mb-4 pb-0">By combining the power of Bitcoin and the Internet, we're building <?php echo e($settings->site_name); ?>  Trading Limited, an alternative ecosystem. One that has sovereignty embedded in its blueprint and allows us to, finally, take ownership of our money.</p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="details">
                ...
                <p>CEO <?php echo e($settings->site_name); ?> </p>
                <div class="social">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\remedy\resources\views/home/about.blade.php ENDPATH**/ ?>