...
<head>
  ...
  <link href="<?php echo e(asset('dash2/public/dashboard/plugins/custom/leaflet/leaflet.bundle.css')); ?>" rel="stylesheet" type="text/css" />
  ...
  <link rel="stylesheet" href="<?php echo e(asset('dash2/konanauth/public/vendor/megaphone/css/megaphone.css')); ?>">
  <style >[wire\:loading], [wire\:loading\.delay], [wire\:loading\.inline-block], [wire\:loading\.inline], [wire\:loading\.block], [wire\:loading\.flex], [wire\:loading\.table], [wire\:loading\.grid], [wire\:loading\.inline-flex] {display: none;}[wire\:loading\.delay\.shortest], [wire\:loading\.delay\.shorter], [wire\:loading\.delay\.short], [wire\:loading\.delay\.long], [wire\:loading\.delay\.longer], [wire\:loading\.delay\.longest] {display:none;}[wire\:offline] {display: none;}[wire\:dirty]:not(textarea):not(input):not(select) {display: none;}input:-webkit-autofill, select:-webkit-autofill, textarea:-webkit-autofill {animation-duration: 50000s;animation-name: livewireautofill;}@keyframes  livewireautofill { from {} }</style>
    ...
    @font-face {
        font-family: Graphik;
        font-weight: 500;
        src: url("<?php echo e(asset('dash2/konanauth/public/https://nothingdevelopers.xyz/konan/public/asset/fonts/Graphik/GraphikRegular.otf')); ?>");
    }
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled">
      ...
      <div class="modal-content">
        ...
        @crsf
          <div class="modal-body">
            <p>Your username for receiving money on <?php echo e($settings->site_name); ?></p>
            <div class="fv-row mb-6">
              <div class="input-group mb-3">
                <span class="input-group-text border-0">@</span>
                <input class="form-control form-control-lg form-control-solid slug_username text-lowercase" maxlength="25" value="<?php echo e(Auth::user()->username); ?>" type="text" name="tag" placeholder="Username" required onkeypress="return AvoidSpace(event);" onblur="this.value=removeSpaces(this.value);" onmouseout="this.value=removeSpaces(this.value);" required />
              </div>
    ...
    <div class="page d-flex flex-row flex-column-fluid">
      <div id="kt_aside" class="aside aside-default bg-white aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
        <div class="aside-logo flex-column-auto pt-9 pb-5" id="kt_aside_logo">
          <a href="/">
            <img alt="Logo" src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>" class="logo-default" style="height:auto; max-width:30%;"/>
            <img alt="Logo" src="<?php echo e(asset('storage/app/public/'.$settings->logo)); ?>" class="h-50px logo-minimize" style="height:auto; max-width:30%;"/>
          </a>
        </div>
        <div class="aside-menu flex-column-fluid">
          <div class="menu menu-column menu-fit menu-rounded menu-title-dark menu-icon-dark menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
            <div class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="20px" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer">
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('accounthistory')); ?>">
                  <span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('localtransfer')); ?>">
                  <span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('internationaltransfer')); ?>">
                  <span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('deposits')); ?>">
                  <span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('loan')); ?>">
                  <span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('veiwloan')); ?>">
                  <span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('support')); ?>">
              ...
              <div class="menu-item"><!--begin:Menu link-->
                <a class="menu-link " href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
    ...
    <div class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px" id="kt_notify_button">
            ...
            <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
              ...
              <div class="cursor-pointer symbol symbol-50px symbol-circle" data-kt-menu-trigger="{default: 'click'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                <div class="symbol-label fs-2 fw-bolder text-dark"> <img alt="" src="<?php echo e($settings->site_address); ?>/storage/app/public/photos/<?php echo e(Auth::user()->profile_photo_path); ?>" width="60" height="60" style='border-radius: 50%;'></div>
              </div>
              ...
              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true" style="">
                  ...
                  <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="d-flex flex-column">
                      <div class="fw-bolder d-flex align-items-center fs-5">
                        <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->middlename); ?> <?php echo e(Auth::user()->lastname); ?>
                ...
                <div class="menu-item px-5 mb-0">
                  <a href="<?php echo e(route('support')); ?>" class="menu-link px-5 py-3">
                ...
                <div class="separator"></div>
                <div class="menu-item px-5 mb-0">
                  <a href="<?php echo e(route('profile')); ?>" class="menu-link px-5 py-3">
                ...
                <div class="menu-item px-5 mb-0">
                  <a href="<?php echo e(route('logout')); ?>" class="menu-link px-5 py-3" onclick="event.preventDefault();
                  document.getElementById('logout-form').submit();">
    ...
    <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
      ...
      <div class="container-fluid d-flex flex-column flex-md-row flex-stack">
        ...
        <div class="text-dark order-2 order-md-1">
          ...
          <a href="/" target="_blank" class="text-gray-800 text-hover-primary"><?php echo e($settings->site_name); ?></a>
        </div>
        <!--end::Copyright-->
        <!--begin::Menu-->
  ...
  <script src="<?php echo e(asset('dash2/konanauth/public/dashboard/plugins/global/plugins.bundle.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('dash2/konanauth/public/asset/fonts/fontawesome/js/all.js')); ?>"></script>
<script src="<?php echo e(asset('dash2/konanauth/public/vendor/livewire/livewire.js?id=90730a3b0e7144480175')); ?>" data-turbo-eval="false" data-turbolinks-eval="false" >
</script><script data-turbo-eval="false" data-turbolinks-eval="false" >window.livewire = new Livewire();window.Livewire = window.livewire;window.livewire_app_url = '<?php echo e($settings->site_url); ?>';window.livewire_token = 'XBojR3fhO5iYl8wefukaV6n5mCsjqnBSdc4GbFMk';window.deferLoadingAlpine = function (callback) {window.addEventListener('livewire:load', function () {callback();});};let started = false;window.addEventListener('alpine:initializing', function () {if (! started) {window.livewire.start();started = true;}});document.addEventListener("DOMContentLoaded", function () {if (! started) {window.livewire.start();started = true;}});</script>

</body>

</html>
<script src="<?php echo e(asset('dash2/konanauth/public/public/vendor/livewire/livewire.js?id=90730a3b0e7144480175')); ?>" data-turbo-eval="false" data-turbolinks-eval="false" >

</script><script data-turbo-eval="false" data-turbolinks-eval="false" >window.livewire = new Livewire();window.Livewire = window.livewire;window.livewire_app_url = '<?php echo e($settings->site_url); ?>';window.livewire_token = 'XBojR3fhO5iYl8wefukaV6n5mCsjqnBSdc4GbFMk';window.deferLoadingAlpine = function (callback) {window.addEventListener('livewire:load', function () {callback();});};let started = false;window.addEventListener('alpine:initializing', function () {if (! started) {window.livewire.start();started = true;}});document.addEventListener("DOMContentLoaded", function () {if (! started) {window.livewire.start();started = true;}});</script>
<script src="<?php echo e(asset('dash2/konanauth/public/dashboard/js/alpine.js')); ?>"></script>
<script>
  "use strict"
...
<script>
  function checkTag() {
    var valName = $(".slug_username").val();
    var url = "https://nothingdevelopers.xyz/konan/user/tag/check-tag";
    $.post(url, {
      tag: valName,
      "_token": "XBojR3fhO5iYl8wefukaV6n5mCsjqnBSdc4GbFMk"
    }, function(json) {
      if (json.st == 1) {
        $('#username_button').attr('disabled', false);
        $("#message").show().text('Username is available');
      } else {
        $('#username_button').attr('disabled', true);
        $("#message").show().text('Username isn\'t available');
      }
    }, 'json');
  }

  $(".slug_username").keyup(checkTag);
  if ($(".slug_username").val().trim() != "") {
    checkTag();
  }
</script>
...
<script type="text/javascript">
  ...
  <?php endif; ?><?php /**PATH C:\xampp\htdocs\bank\resources\views/layouts/dash2.blade.php ENDPATH**/ ?>