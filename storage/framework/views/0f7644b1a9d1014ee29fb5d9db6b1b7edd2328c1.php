            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        ...
                        <p class="mt-2">Please check your <a href="<?php echo e(route('veiwloan')); ?>" class="font-medium underline text-yellow-800 hover:text-yellow-900">existing loans</a> for more information.</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <span class="text-gray-500"><?php echo e(Auth::user()->s_curr); ?></span>
                                        </div>
                                        <input 
                                            type="text" 
                                            name="amount" 
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home8/globalch/public_html/auth/resources/views/user/loan.blade.php ENDPATH**/ ?>