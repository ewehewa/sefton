                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-1 text-sm text-red-700">
                                <p>Your <?php echo e($settings->site_name); ?> account has been blocked for security reasons.</p>
                                <div class="mt-3">
                                    <a href="mailto:<?php echo e($settings->contact_email); ?>" class="inline-flex items-center text-sm font-medium text-red-700 hover:text-red-600 transition-colors duration-200">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/globalch/public_html/resources/views/user/pin.blade.php ENDPATH**/ ?>