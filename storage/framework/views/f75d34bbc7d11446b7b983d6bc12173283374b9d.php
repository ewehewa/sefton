								...
								<div class="card-deck">
									<div class="text-center border-0 rounded-lg shadow-lg card card-pricing hover-scale-110 bg-primary popular">
										<div class="py-0 border-0 card-header">
											...
											<div class="py-5">
												<img src="<?php echo e(asset('dash2/img/Wallet.svg.png')); ?>" alt="withdrawal method image" srcset="" class="img-fluid img-center" style="height:90px;">
										...
										<div class="card-body">
											<ul class="mb-4 text-white list-unstyled">
												<li> 
													...
													<p class="text-white h5"><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($method->minimum)); ?></p>
												</li>
												<li>
													<small>Maximum withdrawable amount</small>
													<p class="text-white h5"><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($method->maximum )); ?></p>
												</li>
												...
												<li>
													...
													<strong>
														...
														<?php else: ?>
															<?php echo e(Auth::user()->s_curr); ?><?php echo e($method->charges_amount); ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/fintec.elitemaxpro.click/resources/views/user/withdrawals.blade.php ENDPATH**/ ?>