...
<?php $__env->startSection('title', 'Track IRS Tax Refund'); ?>
                ...
                <div class="p-6">
                    <div class="relative">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="relative">
                                ...
                                <div class="ml-12">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-sm text-gray-500"><?php echo e($refund->created_at->format('M d, Y H:i')); ?></span>
                                    </div>
                            ...
                            <!-- Under Review Step -->
                            <div class="relative">
                                <div class="absolute left-0 w-8 h-8 rounded-full <?php echo e(in_array($refund->status, ['pending', 'approved', 'rejected']) ? 'bg-primary-100' : 'bg-gray-100'); ?> flex items-center justify-center">
                                    <i data-lucide="search" class="h-4 w-4 <?php echo e(in_array($refund->status, ['pending', 'approved', 'rejected']) ? 'text-gray-600' : 'text-gray-400'); ?>"></i>
                                </div>
                                <div class="ml-12">
                                    <div class="flex items-center justify-between">
                                        <h3 class="text-lg font-medium text-gray-900">Under Review</h3>
                                        <span class="text-sm text-gray-500"><?php echo e($refund->status === 'pending' ? 'In Progress' : ($refund->status === 'approved' ? 'Completed' : 'Completed')); ?></span>
                                    </div>
                            ...
                            <!-- Decision Step -->
                            <div class="relative">
                                <div class="absolute left-0 w-8 h-8 rounded-full <?php echo e(in_array($refund->status, ['approved', 'rejected']) ? 'bg-primary-100' : 'bg-gray-100'); ?> flex items-center justify-center">
                                    <i data-lucide="<?php echo e($refund->status === 'approved' ? 'check-circle' : ($refund->status === 'rejected' ? 'x-circle' : 'clock')); ?>" class="h-4 w-4 <?php echo e(in_array($refund->status, ['approved', 'rejected']) ? 'text-primary-600' : 'text-gray-400'); ?>"></i>
                                </div>
                                <div class="ml-12">
                                    <div class="flex items-center justify-between">
                                        <h3 class="text-lg font-medium text-gray-900">Decision</h3>
                                        <span class="text-sm text-gray-500"><?php echo e($refund->status === 'pending' ? 'Pending' : ($refund->status === 'approved' ? 'Approved' : 'Rejected')); ?></span>
                                    </div>
                ...
                <div class="border-t border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p class="text-lg font-semibold text-gray-900"><?php echo e($refund->id); ?></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="text-sm font-medium text-gray-500 mb-2">Filing ID</h4>
                            <p class="text-lg font-semibold text-gray-900"><?php echo e($refund->filing_id); ?></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="text-sm font-medium text-gray-500 mb-2">Submission Date</h4>
                            <p class="text-lg font-semibold text-gray-900"><?php echo e($refund->created_at->format('M d, Y')); ?></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="text-sm font-medium text-gray-500 mb-2">Status</h4>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                <?php echo e($refund->status === 'approved' ? 'bg-green-100 text-green-800' : 
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p class="text-lg font-semibold text-gray-900"><?php echo e($refund->updated_at->format('M d, Y H:i')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 p-6">
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div class="flex gap-3">
                            <a href="<?php echo e(route('support')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                                <i data-lucide="message-circle" class="h-4 w-4 mr-2"></i> Contact Support
                            </a>
                            <a href="<?php echo e(route('irs-refund')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/globalch/public_html/resources/views/user/irs-refund/track.blade.php ENDPATH**/ ?>