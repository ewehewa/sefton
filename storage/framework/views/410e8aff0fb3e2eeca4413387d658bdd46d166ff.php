    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 dark:from-primary-700 dark:via-primary-800 dark:to-primary-900 relative overflow-hidden">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-8 z-10">
            ...
            <p class="text-sm mb-8 max-w-md text-center text-white/80 leading-relaxed">
                Secure access to your <?php echo e($settings->site_name); ?> account with our simple password recovery process.
            </p>
                    ...
                    <form method="POST" action="<?php echo e(route('password.email')); ?>" class="space-y-4">
                        ...
                        <div class="pt-2">
                            <button 
                                ...
                                <i class="fas fa-paper-plane mr-2 group-hover:translate-x-1 transition-transform text-sm"></i>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>