...
<?php endif; ?>
    ...
    <?php echo $__env->make('partials.dashboard.mobile_view', [
    ...
    <?php echo $__env->make('partials.dashboard.desktop_left', [
        'monthly_deposits' => $monthly_deposits ?? 0,
        'monthly_expenses' => $monthly_expenses ?? 0,
    ...
    <?php echo $__env->make('partials.dashboard.desktop_right', [
        'recentTransactions' => $recentTransactions,
        'settings' => $settings,
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/dashboard.blade.php ENDPATH**/ ?>