            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-shrink-0">
                    <div class="w-8 h-8 rounded-xl bg-red-100 dark:bg-red-900/30 flex items-center justify-center">
                        <i class="fa-solid fa-circle-exclamation text-red-600 dark:text-red-400 text-sm"></i>
                    </div>
                </div>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-red-800 dark:text-red-200 mb-1">
                                <?php echo e(count($errors->all()) === 1 ? 'Validation Error' : 'Validation Errors'); ?>
...
<?php endif; ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/components/error-alert.blade.php ENDPATH**/ ?>