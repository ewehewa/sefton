    ...
    <div class="flex flex-col mb-6">
        <div>
            ...
            <div class="flex items-center text-sm text-gray-500">
                ...
                <a href="<?php echo e(route('deposits')); ?>" class="hover:text-primary-600">Deposits</a>
                <i data-lucide="chevron-right" class="h-4 w-4 mx-2"></i>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="flex items-center">
                    <?php if($title != "Complete Payment"): ?>
                        ...
                        <h2 class="text-xl font-semibold text-gray-900">Payment Method: <?php echo e($payment_mode->name); ?></h2>
                    <?php else: ?>
                ...
                <div class="mt-2 md:mt-0 md:ml-4">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-primary-100 text-gray-800">
                        Amount: <?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($amount)); ?> <?php echo e(Auth::user()->curr); ?>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <p>You are to make payment of <strong><?php echo e(Auth::user()->s_curr); ?><?php echo e(number_format($amount)); ?></strong> using your selected payment method. Screenshot and upload the proof of payment.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center mb-6">
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center w-full max-w-xs">
                        ...
                        <div class="bg-white p-2 rounded-lg border border-gray-200 mb-3 w-full flex justify-center">
                            ...
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?php echo e(urlencode($qrContent)); ?>" alt="Payment QR Code" class="w-48 h-48">
                        </div>
                        <p class="text-sm text-gray-500 text-center">Scan the QR code with your payment app</p>
                        <div class="mt-2 text-center w-full">
                            <p class="text-xs text-gray-700 font-medium"><?php echo e($payment_mode->name); ?> Address:</p>
                            <p class="text-xs text-gray-600 break-all"><?php echo e($payment_mode->wallet_address); ?></p>
                            <p class="text-xs text-gray-700 font-medium mt-1">Amount:</p>
                            <p class="text-xs text-gray-600"><?php echo e(Auth::user()->s_curr); ?><?php echo e($amount); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="flex flex-col items-center justify-center p-6">
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 flex flex-col items-center max-w-md">
                        ...
                        <div class="bg-white p-3 rounded-lg border border-gray-200 mb-4">
                            <img src="<?php echo e($p_qrcode); ?>" alt="Payment QR code" class="w-48 h-48">
                        </div>
                        
                        <div class="mb-4 w-full">
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($coin); ?> Address</label>
                            <div class="flex">
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/atlantictruist/public_html/resources/views/user/payment.blade.php ENDPATH**/ ?>