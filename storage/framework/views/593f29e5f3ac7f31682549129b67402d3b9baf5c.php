...
} elseif ($_instance->childHasBeenRendered('GUZn1iN')) {
    $componentId = $_instance->getRenderedChildComponentId('GUZn1iN');
    $componentTag = $_instance->getRenderedChildComponentTagName('GUZn1iN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GUZn1iN');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('GUZn1iN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('pkZVqIz')) {
    $componentId = $_instance->getRenderedChildComponentId('pkZVqIz');
    $componentTag = $_instance->getRenderedChildComponentTagName('pkZVqIz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pkZVqIz');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('pkZVqIz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prostableassets/public_html/fund/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>