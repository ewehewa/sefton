...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-3 lg:p-4">
    <div class="max-w-8xl mx-auto">
        <div x-data="{ 
            ...
            income: '',
            isSubmitting: false,
            hasActiveLoan: <?php echo e(\App\Models\User_plans::where('user', Auth::user()->id)->whereIn('active', ['Active', 'Processed', 'Pending'])->count() > 0 ? 'true' : 'false'); ?>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-1 text-sm text-yellow-700 dark:text-yellow-400">
                                ...
                                <p class="mt-1">Please check your <a href="<?php echo e(route('veiwloan')); ?>" class="font-medium underline text-yellow-800 dark:text-yellow-300 hover:text-yellow-900 dark:hover:text-yellow-200">existing loans</a> for more information.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div x-show="showApplicationForm && !hasActiveLoan">
                <div class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 dark:border-gray-700/50 overflow-hidden">
                    ...
                    <div class="p-4 lg:p-5">
                        ...
                        <form action="<?php echo e(route('loan')); ?>" method="post" x-ref="loanForm" @submit="isSubmitting = true">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label for="amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                                Loan Amount (<?php echo e(Auth::user()->curr); ?>) <span class="text-red-500">*</span>
                                            </label>
                                                                                    <div class="relative">
                                ...
                                <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-600/50 p-4">
                                    ...
                                    <div>
                                        ...
                                        <select 
                                            ...
                                            required
                                        >
                                            <option value="2,000-5,000"><?php echo e(Auth::user()->s_curr); ?>2,000 - <?php echo e(Auth::user()->s_curr); ?>5,000</option>
                                            <option value="6,000-10,000"><?php echo e(Auth::user()->s_curr); ?>6,000 - <?php echo e(Auth::user()->s_curr); ?>10,000</option>
                                            <option value="11,000-20,000"><?php echo e(Auth::user()->s_curr); ?>11,000 - <?php echo e(Auth::user()->s_curr); ?>20,000</option>
                                            <option value="21,000-50,000"><?php echo e(Auth::user()->s_curr); ?>21,000 - <?php echo e(Auth::user()->s_curr); ?>50,000</option>
                                            <option value="100,000 and above"><?php echo e(Auth::user()->s_curr); ?>100,000 and above</option>
                                        </select>
                                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none z-10">
                                            <i class="fas fa-chevron-down text-gray-400 text-xs"></i>
                                        </div>
                                ...
                                <div class="flex items-start mb-3">
                                    ...
                                    <div class="ml-3 text-sm">
                                        ...
                                        <p class="text-gray-500 dark:text-gray-400 mt-1 text-xs">
                                            By submitting this application, I confirm that all information provided is accurate and complete. I authorize <?php echo e($settings->site_name); ?> to verify my information and credit history.
                                        </p>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/loan.blade.php ENDPATH**/ ?>