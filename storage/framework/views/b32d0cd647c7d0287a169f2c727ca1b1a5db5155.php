        ...
        <div class="w-full max-w-sm">
            ...
            <?php elseif(Session::has('success')): ?>
                <div class="bg-green-50/90 dark:bg-green-900/30 backdrop-blur-sm border border-green-200/50 dark:border-green-800/50 text-green-700 dark:text-green-300 p-3 mb-4 rounded-xl" role="alert">
                    <div class="flex items-center">
                        ...
                        <p class="text-sm font-medium"><?php echo e(Session::get('success')); ?></p>
                    </div>
                </div>
            <?php else: ?>
            ...
            <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                ...
                <div class="px-6 pb-6 pt-4">
                    <form method="POST" action="<?php echo e(route('verification.verify-code')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/auth/verify-email.blade.php ENDPATH**/ ?>