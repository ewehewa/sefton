...
<?php endif; ?>
                ...
                <div class="mb-5 row">
                    <div class="p-3 col-12">
                        <a href="#" data-toggle="modal" data-target="#faqmodal" class="btn "><i
                        ...
                        <a href="#" data-toggle="modal" data-target="#testi" class="btn "><i class="fa fa-plus"></i>
                            Add Tesimonial</a>
                        ...
                        <a href="#" data-toggle="modal" data-target="#images" class="btn "><i
                        ...
                        <div id="images" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body ">
                                        <form action="<?php echo e(route('saveimg')); ?>" method="post"
                    ...
                    <div class="col-12">
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="mb-2 nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                    href="#1" role="tab" aria-controls="nav-home" aria-selected="true">
                                    FAQ(S)</a>
                        ...
                        <div class="px-3 py-3 tab-content px-sm-0" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active  card p-3" id="1" role="tabpanel"
                            ...
                            <div class="tab-pane fade card  p-3" id="2" role="tabpanel"
                            ...
                            <div class="tab-pane fade card  p-3" id="3" role="tabpanel"
                            ...
                            <div class="tab-pane fade card  p-3" id="4" role="tabpanel"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/admin/frontpage.blade.php ENDPATH**/ ?>