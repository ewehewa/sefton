                ...
                <div class="max-w-3xl mx-auto">
                    ...
                    <div class="bg-gray-50/80 dark:bg-gray-700/80 backdrop-blur-sm border border-gray-100/50 dark:border-gray-600/50 rounded-xl p-4 lg:p-5 shadow-sm max-w-xl mx-auto">
                        ...
                        <div class="text-center opacity-0 transition-opacity duration-500" id="viewResultsBtn">
                            <a href="<?php echo e(route('grant.results')); ?>" class="inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200">
...
<?php echo $__env->make('layouts.dash2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/user/grant/processing.blade.php ENDPATH**/ ?>