...
<?php endif; ?>
            <div >
    <form class="form w-100" action="<?php echo e(route('internationaltransfer')); ?>"  method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="fv-row mb-6">
            <div class="input-group mb-3">
                <span class="input-group-text border-0 fs-2"><?php echo e($settings->currency); ?></span>
                                <input class="form-control form-control-lg form-control-solid fs-2 fw-bold " type="number" step="any" name="amount" autocomplete="transaction-amount" id="amount" min="1" max="<?php echo e(number_format(Auth::user()->account_bal, 2, '.', ',')); ?>" value="" required placeholder="0.00" />
...
<?php echo $__env->make('layouts.dashtransfer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedydevcodes.com/public_html/resources/views/user/international.blade.php ENDPATH**/ ?>