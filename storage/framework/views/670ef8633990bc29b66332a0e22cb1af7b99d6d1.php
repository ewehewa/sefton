...
} elseif ($_instance->childHasBeenRendered('AYN5uLw')) {
    $componentId = $_instance->getRenderedChildComponentId('AYN5uLw');
    $componentTag = $_instance->getRenderedChildComponentTagName('AYN5uLw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AYN5uLw');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('AYN5uLw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedycodes/public_html/fin.remedycodes.online/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>