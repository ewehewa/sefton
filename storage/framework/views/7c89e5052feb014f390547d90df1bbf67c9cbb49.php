...
} elseif ($_instance->childHasBeenRendered('Cn5scax')) {
    $componentId = $_instance->getRenderedChildComponentId('Cn5scax');
    $componentTag = $_instance->getRenderedChildComponentTagName('Cn5scax');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Cn5scax');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('Cn5scax', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTraderSoftware/onlinetrader/resources/views/admin/subscription/master/statistics.blade.php ENDPATH**/ ?>