    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 dark:from-primary-700 dark:via-primary-800 dark:to-primary-900 relative overflow-hidden">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-8 z-10">
            ...
            <h1 class="text-3xl font-black mb-3 text-center bg-gradient-to-r from-white via-white to-white/80 bg-clip-text text-transparent">
                Join <?php echo e($settings->site_name); ?>
            ...
            <p class="text-sm mb-8 max-w-md text-center text-white/80 leading-relaxed">
                Start your financial journey with <?php echo e($settings->site_name); ?>. Secure, fast, and reliable banking at your fingertips.
            </p>
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-3 lg:p-8 bg-gray-50/50 dark:bg-gray-900/50 backdrop-blur-sm">
        <div class="w-full max-w-sm">
            ...
            <div class="lg:hidden text-center mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Join <?php echo e($settings->site_name); ?> today</p>
            </div>
                ...
                <div class="px-6 pb-6 pt-4">
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-semibold transition-colors">
                                Sign In
                            </a>
                        </p>
                    </div>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.guest2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nezertechy/public_html/nexa.nezertechy.com/resources/views/auth/register.blade.php ENDPATH**/ ?>