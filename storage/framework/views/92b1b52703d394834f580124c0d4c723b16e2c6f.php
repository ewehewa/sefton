...
} elseif ($_instance->childHasBeenRendered('oKItlLC')) {
    $componentId = $_instance->getRenderedChildComponentId('oKItlLC');
    $componentTag = $_instance->getRenderedChildComponentTagName('oKItlLC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oKItlLC');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('oKItlLC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedyfinance/public_html/account/resources/views/user/withdraw.blade.php ENDPATH**/ ?>